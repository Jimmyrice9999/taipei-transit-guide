...
const stationProse: Record<string, StationProseSentence[]> = {
  ...
  LB06: [
    { text: 'The route record places LB06 in Sanxia on Guoqing Road and appends National Education Research Academy as a location name.', source: dortsRoute.id },
    { text: 'The public-art index describes the Sanying project as 14.29 kilometres long with 12 elevated stations, placing LB06 in a continuous elevated corridor.', source: publicArtIndex.id },
    { text: 'The builder engineering documentary says the elevated alignment crosses national and railway infrastructure, the Dahan River, the Sanxia River and Yingge Creek.', source: engineeringRisks.id },
    { text: 'It records a fish-fin bridge at the railway crossing, a protective base plate under the work vehicle, railway supervision and a night operation with a TRA power-off section.', source: engineeringRisks.id },
    { text: 'Those measures describe the line construction risk controls and do not establish an LB06-specific incident.', source: engineeringRisks.id },
    { text: 'The LB06 architecture article explains that the expanded-metal platform skin both reduces material weight and allows air to pass through the station enclosure.', source: lb06Architecture.id },
    { text: 'It says clerestory openings use heat buoyancy and train movement to exhaust hot air, making ventilation part of the station structural and environmental strategy.', source: lb06Architecture.id },
    { text: 'The 2025 public-art announcement places Footprints - Building Footprints within the line mobile-museum programme and identifies LB06 as one of its station works.', source: linePublicArt.id },
    { text: 'The 2026 announcement again assigns Footprints - Building Footprints to LB06 while describing the wider programme as 12 works by 13 artist groups.', source: linePublicArt2026.id },
    { text: 'The two announcements agree on the LB06 title; neither establishes a separate LB06 artist fee or selection cost.', source: linePublicArt2026.id },
    { text: 'The fetched primary pages do not establish a separate LB06 civil construction contract, final account, individual architect, rename gazette or confirmed feeder-bus stop-ID join.', source: dortsRoute.id },
    { text: 'Those station-specific gaps remain TBC rather than being inferred from a line-level engineering article or a public-art programme announcement.', source: engineeringRisks.id },
  ...
  LB07: [
    { text: 'The route record places LB07 at National Taipei University in Sanxia and appends Enzhugong Hospital as a location name.', source: dortsRoute.id },
    { text: 'The public-art index lists Gather - Flow at the National Taipei University station, providing a station-specific title in the builder inventory.', source: publicArtIndex.id },
    { text: 'DORTS describes the Sanying project as a 14.29-kilometre route with 12 elevated stations, so LB07 belongs to the same elevated corridor as the surrounding Sanxia stations.', source: publicArtIndex.id },
    { text: 'The engineering documentary says the elevated alignment crosses national and railway infrastructure and the Dahan, Sanxia and Yingge waterways.', source: engineeringRisks.id },
    { text: 'For the railway crossing, it records a fish-fin bridge, protective base-plate work, railway supervision and a night TRA power-off section.', source: engineeringRisks.id },
    { text: 'The documentary high-risk description is corridor evidence and does not report an LB07-specific accident or construction dispute.', source: engineeringRisks.id },
    { text: 'The full 2025 public-art announcement describes the Sanying programme as a mobile museum linking station works through a shared story.', source: linePublicArt.id },
    { text: 'Its station list assigns Gather - Flow to LB07, matching the later 2026 announcement rather than supplying a competing title.', source: linePublicArt.id },
    { text: 'The 2026 announcement says the line-wide programme includes physical and augmented-reality forms, but the fetched pages do not provide a separately verified LB07 medium.', source: linePublicArt2026.id },
    { text: 'The direct individual LB07 artwork page was not used because the full fetch returned a cache-miss failure; the announcement and index are the surviving primary records for the title.', source: linePublicArt2026.id },
    { text: 'The fetched primary records do not establish an LB07 civil contract value, final account, individual architect, public-art cost, rename gazette or confirmed feeder-bus stop-ID join.', source: dortsRoute.id },
    { text: 'Those missing station-level fields remain TBC, while the route, engineering and public-art programme context is retained as such.', source: engineeringRisks.id },
  ...
  LB08: [
    { text: 'The route record places LB08 at Yingge station on Guanqian Road and records its connection with the Taiwan Railways station.', source: dortsRoute.id },
    { text: 'The full corridor article describes a coloured reinforced-glass weather passage from the Sanying station to TRA Yingge and a bridge continuing toward the New Taipei Art Museum.', source: lb08Corridor.id },
    { text: 'That article gives seven minutes as the planned walking time from the station toward the museum, which is a design target rather than a measured current journey time.', source: lb08Corridor.id },
    { text: 'The builder public-art index places Yingge within the 14.29-kilometre, 12-station elevated Sanying project.', source: publicArtIndex.id },
    { text: 'The engineering documentary says the elevated line crosses national and railway infrastructure and the Dahan, Sanxia and Yingge waterways.', source: engineeringRisks.id },
    { text: 'Its railway-crossing account records a fish-fin bridge, a protective base plate, railway supervision and a night TRA power-off operation.', source: engineeringRisks.id },
    { text: 'These are line-level construction controls and do not establish an LB08-specific structural incident.', source: engineeringRisks.id },
    { text: 'The individual LB08 art record names Tao Xiang and describes a practical lighting installation on the institutional corridors, while also identifying Yingge ceramic and kiln context.', source: lb08Art.id },
    { text: 'The full 2025 public-art announcement instead lists Reed Flower Street Lamp for LB08 in its station-by-station assignment.', source: linePublicArt.id },
    { text: 'That same individual LB08 record separately places Flower Street Lamp on the corridor toward the New Taipei Art Museum, so the records describe both Tao Xiang and a street-lamp work in the LB08-area programme.', source: lb08Art.id },
    { text: 'The 2026 announcement omits LB08 from its station-by-station sentence while calling the programme 12 works, so it does not resolve the earlier LB08 assignment difference.', source: linePublicArt2026.id },
    { text: 'These are conflicting official public-art assignments and descriptions, not values to average or silently reconcile.', source: linePublicArt.id },
    { text: 'The fetched primary records do not establish a separate LB08 civil contract value, final account, individual architect, complete art cost, rename gazette or confirmed feeder-bus stop-ID join.', source: dortsRoute.id },
    { text: 'The unresolved station-level fields remain TBC; the planned weather-corridor time remains distinct from an observed transfer time.', source: lb08Corridor.id },
  ...
  LB09: [
    { text: 'The route record places LB09 at Ceramics Old Street in Yingge on Chongqing Street, connecting the station context to the district ceramics corridor.', source: dortsRoute.id },
    { text: 'The public-art index lists Playing with Clay at Ceramics Old Street and places the station within the 14.29-kilometre Sanying Line of 12 elevated stations.', source: publicArtIndex.id },
    { text: 'The individual art record says the work occupies four ground-level station columns and identifies Liu Zhenzhou as its artist.', source: lb09Art.id },
    { text: 'It describes glaze painting, glaze variation, ceramic texture and firing effects as the material techniques used to represent Yingge ceramic diversity.', source: lb09Art.id },
    { text: 'The 2026 public-art announcement lists Playing with Clay at LB09 as part of the line mobile-museum programme.', source: linePublicArt2026.id },
    { text: 'The 2025 announcement broader programme description also treats the Sanying stations as a connected public-art route rather than unrelated isolated commissions.', source: linePublicArt.id },
    { text: 'The two announcements and the individual art page agree on the LB09 title; the individual page supplies the artist and installation description.', source: lb09Art.id },
    { text: 'The engineering documentary describes the full line as elevated and records crossings of national and railway infrastructure, the Dahan River, the Sanxia River and Yingge Creek.', source: engineeringRisks.id },
    { text: 'For the railway crossing it records a fish-fin bridge, protective base-plate work, railway supervision and a night TRA power-off operation.', source: engineeringRisks.id },
    { text: 'Those controls are corridor-level construction evidence and not an LB09-specific incident report.', source: engineeringRisks.id },
    { text: 'The public-art sources establish the work title, artist, location and techniques but do not establish its selection cost or a separate final art account.', source: lb09Art.id },
    { text: 'The fetched primary records do not establish an LB09 civil construction contract value, final account, individual architect, rename gazette or confirmed feeder-bus stop-ID join.', source: dortsRoute.id },
    { text: 'Those missing station-specific fields remain TBC rather than being inferred from the ceramics district or the line-wide engineering record.', source: engineeringRisks.id },
  ...
  LB10: [
    { text: 'The route record places LB10 at Guohua on Guohua Road in Yingge, between the ceramics-station area and the southern end of the line.', source: dortsRoute.id },
    { text: 'The public-art index lists Time Journey and Tao Xiang for LB10 in its station inventory.', source: publicArtIndex.id },
    { text: 'The full 2025 announcement also assigns Time Journey to LB10, so that title is consistent across the two announcement dates.', source: linePublicArt.id },
    { text: 'The 2026 announcement adds Tao Xiang to LB10 station listing, but the separately fetched LB08 art record names Tao Xiang at LB08 and describes a related corridor installation there.', source: lb08Art.id },
    { text: 'The official records therefore publish Tao Xiang in both an LB08 individual record and the LB10 station assignment, without explaining whether this is one work with multiple placements or two uses of the same title.', source: linePublicArt2026.id },
    { text: 'That is a published assignment conflict, not a reason to choose one station or to merge the records silently.', source: lb08Art.id },
    { text: 'The line public-art index describes the Sanying project as 14.29 kilometres with 12 elevated stations and a connected mobile-museum programme.', source: publicArtIndex.id },
    { text: 'The engineering documentary says the elevated alignment crosses national and railway infrastructure and the Dahan, Sanxia and Yingge waterways.', source: engineeringRisks.id },
    { text: 'Its railway-crossing controls include a fish-fin bridge, protective base plate, railway supervision and a night TRA power-off section.', source: engineeringRisks.id },
    { text: 'This is evidence about the line construction method and not an LB10-specific incident history.', source: engineeringRisks.id },
    { text: 'The fetched public-art announcements establish LB10 title assignments but do not supply an individual LB10 artist, medium, selection process or cost in the material used here.', source: linePublicArt2026.id },
    { text: 'The fetched primary pages also do not establish an LB10 civil construction contract value, final account, individual architect, rename gazette or confirmed feeder-bus stop-ID join.', source: dortsRoute.id },
    { text: 'Those missing station-level values remain TBC, and the Tao Xiang assignment remains published as a conflict until a primary record explains the relationship.', source: linePublicArt2026.id },
  ...
  LB11: [
    { text: 'The route record places LB11 at Yongji Park in Yingge on Taoyuan Road and identifies the station as part of the southern Yingge section.', source: dortsRoute.id },
    { text: 'The public-art index lists Convenient Passage: Ying Bird Yongji at LB11 within the 14.29-kilometre, 12-elevated-station Sanying project.', source: publicArtIndex.id },
    { text: 'The full individual art record identifies Chen Hongcheng as the artist and places the work on ground-level columns and walls.', source: lb11Art.id },
    { text: 'Its title and narrative use the movement of birds leaving and returning to nests as a metaphor for passengers daily journeys.', source: lb11Art.id },
    { text: 'The 2026 public-art announcement assigns Convenient Passage: Ying Bird Yongji to LB11 and includes it in the line mobile-museum programme.', source: linePublicArt2026.id },
    { text: 'The announcement describes the wider programme as 12 works by 13 artist groups, including physical and augmented-reality forms.', source: linePublicArt2026.id },
    { text: 'The individual art page supplies LB11 artist and placement detail that the line-wide announcement does not repeat.', source: lb11Art.id },
    { text: 'The engineering documentary describes the full elevated line crossing national and railway infrastructure and the Dahan, Sanxia and Yingge waterways.', source: engineeringRisks.id },
    { text: 'Its documented railway controls include a fish-fin bridge, protective base plate, railway supervision and a night TRA power-off operation.', source: engineeringRisks.id },
    { text: 'Those controls are line-level construction evidence and do not establish an LB11-specific incident.', source: engineeringRisks.id },
    { text: 'The fetched art record establishes the title, artist, placement and narrative scope but does not establish a selection cost, fabrication account or opening date.', source: lb11Art.id },
    { text: 'The fetched primary records do not establish an LB11 civil construction contract value, final account, individual architect, rename gazette or confirmed feeder-bus stop-ID join.', source: dortsRoute.id },
    { text: 'Those station-specific gaps remain TBC rather than being filled from the line-wide engineering or public-art programme records.', source: engineeringRisks.id },
...
const stationProseSources: Record<string, Source[]> = {
  ...
  LB06: [dortsRoute, publicArtIndex, linePublicArt, linePublicArt2026, engineeringRisks, lb06Architecture],
  LB07: [dortsRoute, publicArtIndex, linePublicArt, linePublicArt2026, engineeringRisks],
  LB08: [dortsRoute, publicArtIndex, linePublicArt, linePublicArt2026, engineeringRisks, lb08Art, lb08Corridor],
