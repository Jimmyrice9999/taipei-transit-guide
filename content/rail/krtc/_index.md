...
The [signalling and automation record](/rail/krtc/technology/signalling/) covers train control separately: the Red and Orange Lines run with drivers on Siemens track-circuit interlockings, while the under-construction Yellow Line will be a fully driverless Siemens CBTC system — two different generations, not one upgraded in place. The [rolling-stock record](/rail/krtc/rolling-stock/fleet-roster/) covers the original Siemens fleet, an incoming Hyundai Rotem order, and the separate light-rail and Yellow Line fleets. The [accessibility record](/rail/krtc/facilities/accessibility/) and [ridership record](/rail/krtc/operations/ridership/) cover what the operator states about station facilities and passenger volumes, and what it does not. The [fare history record](/rail/krtc/operations/fares/) covers several ticket products with real, dated NT$ figures — while the base single fare itself is published as a chart posted at station machines rather than as text on the operator's own site. The [joint development record](/rail/krtc/projects/joint-development/) covers the legal basis and process behind Kaohsiung's own transit-oriented development mechanism, with the bureau's case-list page itself out of reach behind client-side rendering.
