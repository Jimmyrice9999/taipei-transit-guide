...
hero:
  ...
  caption: An Innovia set threads the curve into [Liuzhangli](/rail/stations/br07/).
...
Compared with the original [VAL256](/rail/rolling-stock/val256/) fleet the C370
...
Based at [Neihu Depot](/rail/depots/neihu-depot/), the line's full-function
maintenance depot. [Muzha Depot](/rail/depots/muzha-depot/) stables both
