---
title: Zuoying
summary: Zuoying (左營) — TDX station ZUY, Zuoying District, with tra xinzuoying station, kaohsiung metro and city buses named by the operator.
order: 81
operator: THSR
updated: 2026-08-24
facts:
  ...
  - label: "Traditional Chinese"
    ...
    source: tdx-thsr
  - label: "Location"
    value: "Zuoying District, Kaohsiung City"
    source: tdx-thsr
  - label: "Address"
    value: "高雄市左營區高鐵路105號"
    source: tdx-thsr
  ...
  - label: "Named transfers"
    value: "TRA Xinzuoying Station, Kaohsiung Metro and city buses"
...
sources:
  ...
  - id: thsrc-station
    title: "Zuoying station information"
    titleOriginal: "高鐵左營站資訊"
    publisher: "Taiwan High Speed Rail Corporation (台灣高速鐵路股份有限公司)"
    url: "https://www.thsrc.com.tw/ArticleContent/f2519629-5973-4d08-913b-479cce78a356"
    accessed: 2026-08-24
    kind: primary
    lang: zh-Hant
...
Zuoying (左營) is station ID 1070 and TDX station code ZUY in the committed High-Speed Rail snapshot.[^tdx-thsr] It is the southern end of the TDX-ordered list.[^tdx-thsr] The record places it in Zuoying District, Kaohsiung City, at 高雄市左營區高鐵路105號, with a position of 22.68739, 120.30749.[^tdx-thsr] Those coordinates and the postal address are separate fields in the data pull, so the page does not turn a point into a claim about the station’s whole catchment.[^tdx-thsr]

## Opening stage and system role

The Railway Bureau dates Zuoying’s opening to 5 January 2007 and places it in one of the seven stations that opened with High-Speed Rail service.[^rb-thsr] The same source records the route’s 350 km length and twelve-station system, which is why this page distinguishes Zuoying’s local opening date from the railway’s initial service date.[^rb-thsr] The TDX record gives the current identity and location; it does not supply an architectural history or a reason for the name, so those questions remain outside the page’s asserted facts.[^tdx-thsr]

The station’s position also matters for reading later additions. The Railway Bureau lists the 2015 additions as Miaoli, Changhua and Yunlin, followed by Nangang in 2016.[^rb-thsr] Zuoying is therefore described here as part of one of the seven stations that opened with High-Speed Rail service, rather than being silently grouped with the stations that began in January 2007.[^rb-thsr]

## Connections and passenger movement

The operator’s full station page gives the address as 高雄市左營區高鐵路105號 and identifies the passenger connection set as TRA Xinzuoying Station, Kaohsiung Metro and city buses.[^thsrc-station] The practical transfer description is deliberately narrower than a regional transport claim: it records the modes named by THSRC and does not infer an interchange from geographic proximity.[^thsrc-station] For Zuoying, the useful station-to-station question is therefore whether a traveller can follow the operator’s named connection, not whether every nearby bus stop or railway platform belongs to the HSR station.[^thsrc-station]
...
THSRC’s floor navigation for Zuoying lists 1F and 2F.[^thsrc-station] The operator’s floor navigation names 1F and 2F; its transport panel also names the Xinzuoying TRA and Kaohsiung Metro connections, making the southern terminus a multi-system passenger interchange..[^thsrc-station] This is a modest but checkable architectural description: it tells a reader how the operator exposes the passenger levels and what transport connections the station page names, without attributing an architect or an unverified design concept.[^thsrc-station] The national Railway Bureau describes the route as approximately 73% bridges and viaducts, 18% tunnels and 9% embankment or cut sections, but that system-wide ratio does not establish Zuoying’s structure on its own.[^rb-thsr]
