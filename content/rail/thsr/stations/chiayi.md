---
title: Chiayi
summary: Chiayi (嘉義) — TDX station CHY, Taibao City, with city buses named by the operator.
order: 61
operator: THSR
updated: 2026-08-24
facts:
  ...
  - label: "Traditional Chinese"
    ...
    source: tdx-thsr
  - label: "Location"
    value: "Taibao City, Chiayi County"
    source: tdx-thsr
  - label: "Address"
    value: "嘉義縣太保市高鐵西路168號"
    source: tdx-thsr
  - label: "Opening date"
...
sources:
  ...
  - id: thsrc-station
    ...
    titleOriginal: "高鐵嘉義站資訊"
    publisher: "Taiwan High Speed Rail Corporation (台灣高速鐵路股份有限公司)"
    url: "https://www.thsrc.com.tw/ArticleContent/60831846-f0e4-47f6-9b5b-46323ebdcef7"
    accessed: 2026-08-24
    kind: primary
    lang: zh-Hant
...
Chiayi (嘉義) is station ID 1050 and TDX station code CHY in the committed High-Speed Rail snapshot.[^tdx-thsr] It is the tenth station in the TDX-ordered list and one of the original seven opening stations.[^tdx-thsr] The record places it in Taibao City, Chiayi County, at 嘉義縣太保市高鐵西路168號, with a position of 23.45951, 120.32326.[^tdx-thsr] Those coordinates and the postal address are separate fields in the data pull, so the page does not turn a point into a claim about the station’s whole catchment.[^tdx-thsr]

## Opening stage and system role

The Railway Bureau dates Chiayi’s opening to 5 January 2007 and places it in one of the seven stations that opened with High-Speed Rail service.[^rb-thsr] The same source records the route’s 350 km length and twelve-station system, which is why this page distinguishes Chiayi’s local opening date from the railway’s initial service date.[^rb-thsr] The TDX record gives the current identity and location; it does not supply an architectural history or a reason for the name, so those questions remain outside the page’s asserted facts.[^tdx-thsr]

The station’s position also matters for reading later additions. The Railway Bureau lists the 2015 additions as Miaoli, Changhua and Yunlin, followed by Nangang in 2016.[^rb-thsr] Chiayi is therefore described here as part of one of the seven stations that opened with High-Speed Rail service, rather than being silently grouped with the stations that began in January 2007.[^rb-thsr]

## Connections and passenger movement

The operator’s full station page gives the address as 嘉義縣太保市高鐵西路168號 and identifies the passenger connection set as city buses.[^thsrc-station] The practical transfer description is deliberately narrower than a regional transport claim: it records the modes named by THSRC and does not infer an interchange from geographic proximity.[^thsrc-station] For Chiayi, the useful station-to-station question is therefore whether a traveller can follow the operator’s named connection, not whether every nearby bus stop or railway platform belongs to the HSR station.[^thsrc-station]
