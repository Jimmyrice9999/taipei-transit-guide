---
title: "Eastern Main Line"
summary: "Eastern Main Line (東部幹線) in the trunk-family record returned by TDX, with 64 ordered station members in the 2026-08-24 snapshot."
order: 1
operator: TRA
updated: 2026-08-24
facts:
...
TDX returns Eastern Main Line as line ID EL and supplies the Traditional Chinese name 東部幹線 in its Shape record.[^tdx-tra-shape] The StationOfLine record is a separate dataset: it contains 64 ordered members for this line and is the source for the sequence displayed on this page.[^tdx-tra-line] That separation matters because a shape is geometry, while an ordered member list is a station relationship; this page does not infer one from the other.[^tdx-tra-shape][^tdx-tra-line]

The first member in the committed sequence is Badu (0920) and the last is Taitung (6000).[^tdx-tra-line]

## Ordered stations and distance fields

The station table is generated from the complete response retrieved on 2026-08-24, not from a route-map redraw.[^tdx-tra-line] Each row keeps the TDX station ID, the sequence supplied by the data platform and the travelled-distance field when that field exists.[^tdx-tra-line] The final supplied distance is 320.6 km in this snapshot; the guide does not relabel it as a surveyed route length or combine it with another line’s measure.[^tdx-tra-line]
