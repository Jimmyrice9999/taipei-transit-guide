...
The [TRA station-area land-development record](/rail/tra/projects/joint-development/) covers the two-track legal split corporatisation created, and the real signed deals — from a Banqiao Station lease renewal to a Nangang urban-renewal case valued in the tens of billions — that TRA Corp's own annual report names individually.
...
The [Sanmin Station track record](/rail/history/sanmin-station-track/) retains row 119's 2.1 km and 2010/2017 fields beside its Add track explanation and the current Sanmin 6120 EL record.[^tra-construction-history][^tra-station-sanmin][^tdx-tra-line]
