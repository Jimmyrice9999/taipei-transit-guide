...
The [Hualien–Ruisui double-track record](/rail/history/hualien-ruisui-double-track/) retains the operator's 70.5 km 1987–1994 reconstruction record and its listed double-track work beside the current TDX EL interval.[^tra-construction-history][^tdx-tra-line]
The [Su'aoxin–Hanben double-track record](/rail/history/suaoxin-hanben-double-track/) retains the operator's 36.7 km 1992–2003 reconstruction record and its listed heavy-rail and PC-sleeper works beside the current TDX EL interval.[^tra-construction-history][^tdx-tra-line]
