...
On the Western Main Line StationOfLine record, this station has sequence 37 and a supplied travelled distance of 125.3 km.[^tdx-tra-line] The preceding member is Qiding (1240) and the following member is Zaoqiao (3140).[^tdx-tra-line] These are adjacency statements about the ordered dataset; they are not a claim about the stopping pattern of a particular train.[^tdx-tra-line]
