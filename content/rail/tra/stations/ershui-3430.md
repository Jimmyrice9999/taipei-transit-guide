...
On the Western Main Line StationOfLine record, this station has sequence 66 and a supplied travelled distance of 242.9 km.[^tdx-tra-line] The preceding member is Tianzhong (3420) and the following member is Linnei (3450).[^tdx-tra-line] These are adjacency statements about the ordered dataset; they are not a claim about the stopping pattern of a particular train.[^tdx-tra-line]
