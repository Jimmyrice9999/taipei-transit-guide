---
title: "Lingjiao — Taiwan Railways"
summary: "Lingjiao (嶺腳), TDX station 7334, in 新北市; current line membership and coordinates from the 2026-08-24 snapshot."
order: 5
operator: TRA
updated: 2026-08-24
facts:
...
Lingjiao (嶺腳) is station ID 7334 in the TDX Station response retrieved on 2026-08-24.[^tdx-tra-station] That record supplies the English and Traditional Chinese names, the address, administrative city and district, station-class field, coordinates and source update time.[^tdx-tra-station] The page reports those fields as fields: it does not turn the class code 5 into a passenger-service ranking because the checked station response does not define that code in the record itself.[^tdx-tra-station]

The address field is 226001新北市平溪區嶺腳里嶺腳寮 22 號.[^tdx-tra-station] This is the source station address, not a claim about the size of the station site, the walking catchment or every entrance.[^tdx-tra-station] A street address and a coordinate answer different questions, so both are retained when present.[^tdx-tra-station]

## Position on Pingxi Line

On the Pingxi Line StationOfLine record, this station has sequence 5 and a supplied travelled distance of 10.2 km.[^tdx-tra-line] The preceding member is Wanggu (7333) and the following member is Pingxi (7335).[^tdx-tra-line] These are adjacency statements about the ordered dataset; they are not a claim about the stopping pattern of a particular train.[^tdx-tra-line]
