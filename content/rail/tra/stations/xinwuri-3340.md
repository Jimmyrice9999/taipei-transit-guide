---
title: "Xinwuri — Taiwan Railways"
summary: "Xinwuri (新烏日), TDX station 3340, in 臺中市; current line membership and coordinates from the 2026-08-24 snapshot."
order: 57
operator: TRA
updated: 2026-08-24
facts:
...
Xinwuri (新烏日) is station ID 3340 in the TDX Station response retrieved on 2026-08-24.[^tdx-tra-station] That record supplies the English and Traditional Chinese names, the address, administrative city and district, station-class field, coordinates and source update time.[^tdx-tra-station] The page reports those fields as fields: it does not turn the class code 2 into a passenger-service ranking because the checked station response does not define that code in the record itself.[^tdx-tra-station]

The address field is 41456臺中市烏日區三和里高鐵東一路 26 號.[^tdx-tra-station] This is the source station address, not a claim about the size of the station site, the walking catchment or every entrance.[^tdx-tra-station] A street address and a coordinate answer different questions, so both are retained when present.[^tdx-tra-station]

## Position on Western Main Line

On the Western Main Line StationOfLine record, this station has sequence 57 and a supplied travelled distance of 201.4 km.[^tdx-tra-line] The preceding member is Wuri (3330) and the following member is Chenggong (3350).[^tdx-tra-line] These are adjacency statements about the ordered dataset; they are not a claim about the stopping pattern of a particular train.[^tdx-tra-line]
