...
On the Western Main Line StationOfLine record, this station has sequence 92 and a supplied travelled distance of 364.7 km.[^tdx-tra-line] The preceding member is Rende (4260) and the following member is Dahu (4290).[^tdx-tra-line] These are adjacency statements about the ordered dataset; they are not a claim about the stopping pattern of a particular train.[^tdx-tra-line]
