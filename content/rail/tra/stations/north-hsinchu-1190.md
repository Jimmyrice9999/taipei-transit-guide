...
On the Western Main Line StationOfLine record, this station has sequence 32 and a supplied travelled distance of 105.2 km.[^tdx-tra-line] The preceding member is Zhubei (1180) and the following member is Hsinchu (1210).[^tdx-tra-line] These are adjacency statements about the ordered dataset; they are not a claim about the stopping pattern of a particular train.[^tdx-tra-line]
