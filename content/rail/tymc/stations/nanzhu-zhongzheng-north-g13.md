---
title: "Nanzhu Zhongzheng North — Taoyuan Green Line"
summary: "Nanzhu Zhongzheng North (G13) on Taoyuan Metro's under-construction Green Line; location, structure and transfer evidence are kept separate from TDX's Airport MRT operating records."
line: G
operator: TYMC
updated: 2026-08-24
facts:
  ...
  - label: "Structure"
    ...
    source: dorts-green
  - label: "Location"
    value: "Luzhu District, near Zhongzheng North Road and Nanzhu Road"
    source: dorts-green
  - label: "Transfer note"
    value: "TBC"
specs:
...
sources:
  ...
  - id: dorts-gc01-design
    ...
    kind: primary
    lang: zh-Hant
    note: "The GC01 design brief gives G13's art/ecology concept and more precise intersection description."
...
Nanzhu Zhongzheng North is the project-page English rendering of 南竹中正北站（河底） (G13).[^dorts-green] The project table places it at Luzhu District, near Zhongzheng North Road and Nanzhu Road and classifies the station as elevated; those are project-design fields, not observations from a currently operating railway.[^dorts-green]

## Place in the Green Line project

G13 sits in the Taoyuan Green Line station sequence published by the Taoyuan engineering bureau. The source table lists the code, a location description and a transfer note where one has been defined; it does not turn an unnamed station code into a final public name.[^dorts-green] No transfer is listed in the checked row.[^dorts-green]
...
The route is still under construction. A construction-project station should not be described as though it already has passenger service, a live timetable or observed daily use. The engineering bureau’s current page gives the line-wide target as 2030, but it does not provide a station-specific opening date for G13; that field remains TBC here.[^dorts-green]

## Design brief

The GC01 design brief gives G13 a more specific identity than the project registry's elevated-form entry. It calls the concept “Creative Luzhu” and connects the station to art and ecology; the site is described north of the Zhongzheng North Road and Nanzhu Road Section 2 intersection.[^dorts-gc01-design] The brief describes an intended architectural response to that location, not a confirmed public-art installation, final entrance arrangement or operating accessibility provision.
