---
title: "Zhongzheng Daxing — Taoyuan Green Line"
summary: "Zhongzheng Daxing (G10) on Taoyuan Metro's under-construction Green Line; location, structure and transfer evidence are kept separate from TDX's Airport MRT operating records."
line: G
operator: TYMC
updated: 2026-08-24
facts:
  ...
  - label: "Structure"
    ...
    source: dorts-green
  - label: "Location"
    value: "Taoyuan District, near the Zhongzheng Road and Daxing West Road junction"
    source: dorts-green
  - label: "Transfer note"
    value: "TBC"
specs:
...
sources:
  ...
  - id: dorts-gc03-design
    ...
    kind: primary
    lang: zh-Hant
    note: "The GC03 design brief describes G10's arts-district and mixed-urban setting and its tree-growth design metaphor."
...
Zhongzheng Daxing is the project-page English rendering of 中正大興站 (G10).[^dorts-green] The project table places it at Taoyuan District, near the Zhongzheng Road and Daxing West Road junction and classifies the station as underground; those are project-design fields, not observations from a currently operating railway.[^dorts-green]

## Place in the Green Line project

G10 sits in the Taoyuan Green Line station sequence published by the Taoyuan engineering bureau. The source table lists the code, a location description and a transfer note where one has been defined; it does not turn an unnamed station code into a final public name.[^dorts-green] No transfer is listed in the checked row.[^dorts-green]
...
The route is still under construction. A construction-project station should not be described as though it already has passenger service, a live timetable or observed daily use. The engineering bureau’s current page gives the line-wide target as 2030, but it does not provide a station-specific opening date for G10; that field remains TBC here.[^dorts-green]

## Design brief

The GC03 brief distinguishes G10 from the older, tighter urban fabric described for the preceding stations. It places G10 in Taoyuan's arts-district and newer mixed residential-commercial area, where the larger street scale is treated as a three-dimensional urban space. The brief uses a tree-growth metaphor—roots, trunk and branches—to describe the sequence from the old-city station and temple toward this newer district.[^dorts-gc03-design] This records the design narrative, not a claim that the metaphor dictates the built station or its public-art programme.
