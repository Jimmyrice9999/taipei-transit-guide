---
title: "Rende Park — Taoyuan Green Line"
summary: "Rende Park (G02) on Taoyuan Metro's under-construction Green Line; location, structure and transfer evidence are kept separate from TDX's Airport MRT operating records."
line: G
operator: TYMC
updated: 2026-08-24
facts:
  ...
  - label: "Structure"
    ...
    source: dorts-green
  - label: "Location"
    value: "Bade District, near the Feng田 Road and new-road junction"
    source: dorts-green
  - label: "Transfer note"
    value: "Station name is provisional until the new road is named"
    source: dorts-green
specs:
...
Rende Park is the project-page English rendering of 仁德公園站 (G02).[^dorts-green] The project table places it at Bade District, near the Feng田 Road and new-road junction and classifies the station as elevated; those are project-design fields, not observations from a currently operating railway.[^dorts-green]

## Place in the Green Line project

G02 sits in the Taoyuan Green Line station sequence published by the Taoyuan engineering bureau. The source table lists the code, a location description and a transfer note where one has been defined; it does not turn an unnamed station code into a final public name.[^dorts-green] The published transfer statement is: Station name is provisional until the new road is named.[^dorts-green]
