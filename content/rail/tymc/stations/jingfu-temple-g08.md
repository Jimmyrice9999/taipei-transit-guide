---
title: "Jingfu Temple — Taoyuan Green Line"
summary: "Jingfu Temple (G08) on Taoyuan Metro's under-construction Green Line; location, structure and transfer evidence are kept separate from TDX's Airport MRT operating records."
line: G
operator: TYMC
updated: 2026-08-24
facts:
  ...
  - label: "Structure"
    ...
    source: dorts-green
  - label: "Location"
    value: "Taoyuan District, on Zhongzheng Road in front of Yonghe Market"
    source: dorts-green
  - label: "Transfer note"
    value: "TBC"
specs:
...
sources:
  ...
  - id: dorts-gc03-design
    ...
    kind: primary
    lang: zh-Hant
    note: "The GC03 design brief describes G08's Yonghe Market redevelopment and set-back public plaza."
...
Jingfu Temple is the project-page English rendering of 景福宮站 (G08).[^dorts-green] The project table places it at Taoyuan District, on Zhongzheng Road in front of Yonghe Market and classifies the station as underground; those are project-design fields, not observations from a currently operating railway.[^dorts-green]

## Place in the Green Line project

G08 sits in the Taoyuan Green Line station sequence published by the Taoyuan engineering bureau. The source table lists the code, a location description and a transfer note where one has been defined; it does not turn an unnamed station code into a final public name.[^dorts-green] No transfer is listed in the checked row.[^dorts-green]
...
The route is still under construction. A construction-project station should not be described as though it already has passenger service, a live timetable or observed daily use. The engineering bureau’s current page gives the line-wide target as 2030, but it does not provide a station-specific opening date for G08; that field remains TBC here.[^dorts-green]

## Design brief

The GC03 brief ties G08 to the rebuilding of Yonghe Market. It describes the station and its joint-development building as a way to renew the surrounding area, while using a set-back plaza as a gathering space and a new focus for local religious life. That makes the plaza part of the station's stated urban programme, not an inferred amenity from the station name.[^dorts-gc03-design] The brief does not establish the market's construction date, final plaza dimensions or operating facilities.
