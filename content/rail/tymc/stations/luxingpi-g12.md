---
title: "Luxingpi — Taoyuan Green Line"
summary: "Luxingpi (G12) on Taoyuan Metro's under-construction Green Line; location, structure and transfer evidence are kept separate from TDX's Airport MRT operating records."
line: G
operator: TYMC
updated: 2026-08-24
facts:
  ...
  - label: "Structure"
    ...
    source: dorts-green
  - label: "Location"
    value: "Taoyuan District, near Zhongzheng Road and Tong’an Street"
    source: dorts-green
  - label: "Transfer note"
    value: "Future connection to the Nankan transfer hub"
    source: dorts-green
specs:
...
sources:
  ...
  - id: dorts-gc03-design
    ...
    kind: primary
    lang: zh-Hant
    note: "The GC03 design brief describes G12's arts-district setting and planned Nankan transfer-station design response."
...
Luxingpi is the project-page English rendering of 蘆興埤站 (G12).[^dorts-green] The project table places it at Taoyuan District, near Zhongzheng Road and Tong’an Street and classifies the station as underground; those are project-design fields, not observations from a currently operating railway.[^dorts-green]

## Place in the Green Line project

G12 sits in the Taoyuan Green Line station sequence published by the Taoyuan engineering bureau. The source table lists the code, a location description and a transfer note where one has been defined; it does not turn an unnamed station code into a final public name.[^dorts-green] The published transfer statement is: Future connection to the Nankan transfer hub.[^dorts-green]
...
The route is still under construction. A construction-project station should not be described as though it already has passenger service, a live timetable or observed daily use. The engineering bureau’s current page gives the line-wide target as 2030, but it does not provide a station-specific opening date for G12; that field remains TBC here.[^dorts-green]

## Design brief

The GC03 brief places G12 in the same arts-district context as G11 but gives it a transport-development role: the future station area is to combine with development around the Nankan transfer station. The brief describes traffic flows as the design image, with marks on the entrance façades and interwoven forms in the underground station interior.[^dorts-gc03-design] It does not establish a final transfer layout, construction completion or service timetable.
