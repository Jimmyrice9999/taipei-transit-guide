---
title: "Chocolate — Taoyuan Green Line"
summary: "Chocolate (G03) on Taoyuan Metro's under-construction Green Line; location, structure and transfer evidence are kept separate from TDX's Airport MRT operating records."
line: G
operator: TYMC
updated: 2026-08-24
facts:
  ...
  - label: "Structure"
    ...
    source: dorts-green
  - label: "Location"
    value: "Bade District, near Jieshou Road Section 2 and Chocolate Street"
    source: dorts-green
  - label: "Transfer note"
    value: "TBC"
specs:
...
sources:
  ...
  - id: dorts-gc02-design
    ...
    kind: primary
    lang: zh-Hant
    note: "The GC02 design brief describes G03's industrial-urban setting and old-railway-track design theme."
...
Chocolate is the project-page English rendering of 巧克力站 (G03).[^dorts-green] The project table places it at Bade District, near Jieshou Road Section 2 and Chocolate Street and classifies the station as underground; those are project-design fields, not observations from a currently operating railway.[^dorts-green]

## Place in the Green Line project

G03 sits in the Taoyuan Green Line station sequence published by the Taoyuan engineering bureau. The source table lists the code, a location description and a transfer note where one has been defined; it does not turn an unnamed station code into a final public name.[^dorts-green] No transfer is listed in the checked row.[^dorts-green]
...
The route is still under construction. A construction-project station should not be described as though it already has passenger service, a live timetable or observed daily use. The engineering bureau’s current page gives the line-wide target as 2030, but it does not provide a station-specific opening date for G03; that field remains TBC here.[^dorts-green]

## Design brief

The GC02 design brief places G03 at the seam between traditional industrial buildings and the city. Its stated theme continues the old railway through track imagery, using the idea of historical change and industrial development; the brief also presents the station as a possible “rhythm” and public-space prototype for improving surrounding roads and development sites.[^dorts-gc02-design] These are the design team's stated intentions, not evidence that the public-space works or station fit-out are complete.
