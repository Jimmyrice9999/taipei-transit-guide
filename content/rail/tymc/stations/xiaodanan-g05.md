---
title: "Xiaodanan — Taoyuan Green Line"
summary: "Xiaodanan (G05) on Taoyuan Metro's under-construction Green Line; location, structure and transfer evidence are kept separate from TDX's Airport MRT operating records."
line: G
operator: TYMC
updated: 2026-08-24
facts:
  ...
  - label: "Structure"
    ...
    source: dorts-green
  - label: "Location"
    value: "Bade District, near Jieshou Road Section 1 and Zhongyong West Street"
    source: dorts-green
  - label: "Transfer note"
    value: "TBC"
specs:
...
sources:
  ...
  - id: dorts-gc02-design
    title: "Green Line GC02 station design briefs"
    titleOriginal: "桃園捷運綠線車站設計-GC02標"
    publisher: "Taoyuan City Department of Rapid Transit Systems (桃園市政府捷運工程局)"
    url: https://dorts.tycg.gov.tw/cp.aspx?n=23243
    accessed: 2026-09-05
    kind: primary
    lang: zh-Hant
    note: "The GC02 design brief describes G05's Taoyuan Irrigation Canal references and joint-development integration."
...
Xiaodanan is the project-page English rendering of 小大湳站 (G05).[^dorts-green] The project table places it at Bade District, near Jieshou Road Section 1 and Zhongyong West Street and classifies the station as underground; those are project-design fields, not observations from a currently operating railway.[^dorts-green]

## Place in the Green Line project

G05 sits in the Taoyuan Green Line station sequence published by the Taoyuan engineering bureau. The source table lists the code, a location description and a transfer note where one has been defined; it does not turn an unnamed station code into a final public name.[^dorts-green] No transfer is listed in the checked row.[^dorts-green]
...
The route is still under construction. A construction-project station should not be described as though it already has passenger service, a live timetable or observed daily use. The engineering bureau’s current page gives the line-wide target as 2030, but it does not provide a station-specific opening date for G05; that field remains TBC here.[^dorts-green]

## Design brief

The GC02 brief makes the Taoyuan Irrigation Canal the historical and cultural reference for G05. It also says the station's entrances and ventilation towers should be kept visually light and integrated into a future joint-development building, reducing large blank walls while retaining enough distinction for the entrances to read as public transport elements.[^dorts-gc02-design] The source describes an architectural strategy; it does not establish a completed development, final ventilation equipment or an opening date.
