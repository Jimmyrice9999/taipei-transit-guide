---
title: "G19 — Taoyuan Green Line"
summary: "G19 (G19) on Taoyuan Metro's under-construction Green Line; location, structure and transfer evidence are kept separate from TDX's Airport MRT operating records."
line: G
operator: TYMC
updated: 2026-08-29
facts:
  ...
  - label: "Structure"
    ...
    source: dorts-green
  - label: "Location"
    value: "Dayuan District, near Airport MRT A16 Hengshan station"
    source: dorts-green
  - label: "Transfer note"
    value: "Planned transfer to Airport MRT A16 Hengshan station"
    source: dorts-green
...
G19 is the station code published for this unnamed Green Line station; the project page leaves its station name open.[^dorts-green] The project table places it at Dayuan District, near Airport MRT A16 Hengshan station and classifies the station as elevated; those are project-design fields, not observations from a currently operating railway.[^dorts-green]

## Place in the Green Line project

G19 sits in the Taoyuan Green Line station sequence published by the Taoyuan engineering bureau. The source table lists the code, a location description and a transfer note where one has been defined; it does not turn an unnamed station code into a final public name.[^dorts-green] The published transfer statement is: Planned transfer to Airport MRT A16 Hengshan station.[^dorts-green]
