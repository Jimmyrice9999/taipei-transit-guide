---
title: "Arts District — Taoyuan Green Line"
summary: "Arts District (G11) on Taoyuan Metro's under-construction Green Line; location, structure and transfer evidence are kept separate from TDX's Airport MRT operating records."
line: G
operator: TYMC
updated: 2026-08-24
facts:
  ...
  - label: "Structure"
    ...
    source: dorts-green
  - label: "Location"
    value: "Taoyuan District, in front of the Zhongzheng Arts and Culture Business District performance centre"
    source: dorts-green
  - label: "Transfer note"
    value: "TBC"
specs:
...
sources:
  ...
  - id: dorts-gc03-design
    ...
    kind: primary
    lang: zh-Hant
    note: "The GC03 design brief describes G11's arts-district, plaza, exhibition-centre and cultural role."
...
Arts District is the project-page English rendering of 藝文特區站（展演中心） (G11).[^dorts-green] The project table places it at Taoyuan District, in front of the Zhongzheng Arts and Culture Business District performance centre and classifies the station as underground; those are project-design fields, not observations from a currently operating railway.[^dorts-green]

## Place in the Green Line project

G11 sits in the Taoyuan Green Line station sequence published by the Taoyuan engineering bureau. The source table lists the code, a location description and a transfer note where one has been defined; it does not turn an unnamed station code into a final public name.[^dorts-green] No transfer is listed in the checked row.[^dorts-green]
...
The route is still under construction. A construction-project station should not be described as though it already has passenger service, a live timetable or observed daily use. The engineering bureau’s current page gives the line-wide target as 2030, but it does not provide a station-specific opening date for G11; that field remains TBC here.[^dorts-green]

## Design brief

The GC03 brief treats G11 as the cultural focal point of Taoyuan's arts district. It identifies the Taoyuan Arts Plaza and Taoyuan Performing Arts Center as the surrounding civic context and describes the station as a place where the city's culture, art and collective identity are foregrounded after the earlier stations' market, temple and commercial themes.[^dorts-gc03-design] The source establishes the planning intent, not a guaranteed events calendar, public-art commission or completed plaza connection.
