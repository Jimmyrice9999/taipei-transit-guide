---
title: "Danan — Taoyuan Green Line"
summary: "Danan (G04) on Taoyuan Metro's under-construction Green Line; location, structure and transfer evidence are kept separate from TDX's Airport MRT operating records."
line: G
operator: TYMC
updated: 2026-08-24
facts:
  ...
  - label: "Structure"
    ...
    source: dorts-green
  - label: "Location"
    value: "Bade District, near Jieshou Road Section 2 and Yinhua Street"
    source: dorts-green
  - label: "Transfer note"
    value: "Future transfer to the Sanying Line extension to Bade"
    source: dorts-green
specs:
...
sources:
  ...
  - id: dorts-gc02-design
    ...
    kind: primary
    lang: zh-Hant
    note: "The GC02 design brief describes G04's Sanying Line terminus role, surrounding park and palette."
...
Danan is the project-page English rendering of 大湳站 (G04).[^dorts-green] The project table places it at Bade District, near Jieshou Road Section 2 and Yinhua Street and classifies the station as underground; those are project-design fields, not observations from a currently operating railway.[^dorts-green]

## Place in the Green Line project

G04 sits in the Taoyuan Green Line station sequence published by the Taoyuan engineering bureau. The source table lists the code, a location description and a transfer note where one has been defined; it does not turn an unnamed station code into a final public name.[^dorts-green] The published transfer statement is: Future transfer to the Sanying Line extension to Bade.[^dorts-green]
