---
title: Bannan Line
summary: The blue line — the east–west trunk through the main station, built in eight openings over sixteen years, and the one line whose ridership its own operator does not publish separately.
order: 6
line: BL
aliases:
  - 板南線
...
facts:
  - label: Operator
    ...
    source: trtc-bannan
  - label: Termini
    value: Dingpu (BL01) to Nangang Exhibition Center (BL23)
    source: tdx
  - label: Stations
    value: "23"
    source: tdx
  ...
  - label: Service patterns
    value: Nangang Exhibition Center–Dingpu; Nangang Exhibition Center–Far Eastern Hospital
    source: trtc-bannan
specs:
  - label: Route length, BL01 to BL23
    value: "26.65"
    unit: km
    source: tdx
  - label: Route length, as published by zh.wikipedia
    value: "28.2"
    unit: km
    source: zh-bannan
  - label: Short working, BL05 to BL23
    value: "20.48"
    unit: km
    source: tdx
  - label: Stations
  ...
  - label: Short working journey
    ...
    unit: min
    source: trtc-bannan
  - label: Peak headway, whole line
    value: "6"
    unit: min
    source: trtc-bannan
  - label: Peak headway, overlap section
    value: "3"
    unit: min
    source: trtc-bannan
  ...
  - label: Longest gap, BL09 to BL10
    ...
    unit: km
    source: tdx
  - label: Shortest gap, BL06 to BL07
    value: "0.65"
    unit: km
    source: tdx
...
sources:
  ...
  - id: dorts-nangang-line
    ...
    kind: primary
    lang: zh-Hant
    note: "Carries the reason the 1999 sections were rushed — 趕工提前完工 … 為盡速與南北向的淡水、新店、中和與木柵線構成雙十路網. Cited only for that; the extraction of this page mis-converted its ROC calendar years, so every date here is taken from the parent page instead."
  - id: dorts-banqiao-line
    title: Banqiao Line
    titleOriginal: 板橋線
    publisher: Taipei City Government, Department of Rapid Transit Systems (DORTS) 臺北市政府捷運工程局
  ...
  - id: trtc-bannan
    title: Routes and headways — Bannan Line
    titleOriginal: 路線及班距 ─ 板南線
    publisher: Taipei Rapid Transit Corporation 臺北大眾捷運股份有限公司
    url: "https://www.metro.taipei/cp.aspx?n=EAD981369A065968&s=3092796CF14AC78E"
    accessed: 2026-08-10
    kind: primary
    lang: zh-Hant
    note: "The operator's own published service pattern: two patterns, 06:00～24:00, 約6分鐘 at peak with 重疊區間約3分鐘 and 龍山寺站往昆陽方向8～9時平均班距約2分15秒, and 單向運行時間 約48分鐘 / 約38分鐘. It says nothing about the empty extra workings that news reporting describes."
  - id: trtc-ridership-series
    title: Ridership statistics by year and for the preceding month
    ...
    kind: primary
    lang: zh-Hant
    note: "Cited for what it does not contain. Every table splits the network two ways only, 文湖線 against 高運量, under the note 高運量包含淡水信義、松山新店、中和新蘆、板南線 — so this line's ridership is inside an aggregate of four and is not published on its own."
  - id: trtc-ridership-index
    title: Ridership
    titleOriginal: 旅運量
    publisher: Taipei Rapid Transit Corporation 臺北大眾捷運股份有限公司
    ...
    kind: primary
    lang: zh-Hant
    note: "The operator's statistics index: monthly 各站進出量統計 as ODS files back to 民國85年, and monthly 全系統旅運量統計 as HTML. The per-station series is what a line total would have to be built from."
  - id: trtc-ridership-monthly
    title: System-wide ridership, June 2026
    titleOriginal: 全系統旅運量統計 115年6月
    publisher: Taipei Rapid Transit Corporation 臺北大眾捷運股份有限公司
    url: https://web.metro.taipei/RidershipCounts/c/11506.htm
    accessed: 2026-08-10
    kind: primary
    lang: zh-Hant
    note: "One month of the system series: 總乘客數 62,471,614 and 平均每日 2,082,387 for the whole network in June 2026. Quoted here only to show the scale this line sits inside, never as a figure for the line."
  - id: tdx
  ...
  - id: cna-2005
    ...
    publisher: 中央社 (Central News Agency), 2 March 2005, read at the 大紀元 reprint
    url: https://www.epochtimes.com/b5/5/3/2/n833204.htm
    accessed: 2026-08-10
    kind: secondary
    lang: zh-Hant
    note: "Contemporaneous with the trains entering service, and the independent corroboration the C341 procurement story had been waiting for: 由捷運土城線承包商─大陸工程公司採購的六列電聯車, 大陸工程原擬購買的是韓國KOROS公司的電聯車，因未獲捷運局同意, 才改向西門子以新台幣二十二億四千八百餘萬元購得, and 單價比捷運局自行採購的西門子電聯車高出約五成."
  - id: cna-2025
    title: "Bannan Line's densest headway to start earlier from 10 November, adding an estimated 1,500 places"
    titleOriginal: 北捷板南線11/10起提早實施最密班距　估增運1500人
    publisher: 陳昱婷, 中央社 (Central News Agency), 30 October 2025
    url: https://www.cna.com.tw/news/ahel/202510300074.aspx
    accessed: 2026-08-10
    kind: secondary
    lang: zh-Hant
    note: "Reports a two-minute densest headway 亞東醫院站往南港展覽館方向 in the 08:00–08:30 half hour, brought forward to start at 07:30 from 10 November 2025, worth about 1,500 extra places and about 2,000 with the space-optimised cars. Does not match the figure on the operator's own routes-and-headways page, which is why both are given here."
  - id: tvbs-2025
    title: "\"Like New Year's Eve\" on the Bannan Line: empty trains run through to Jiangzicui, leaving Xinpu and Banqiao riders in despair"
    titleOriginal: 北捷板南線「像跨年」！空車直達江子翠站　新埔板橋旅客崩潰
    publisher: 吳亭頤, TVBS, 19 August 2025
    url: https://news.tvbs.com.tw/life/2964956
    accessed: 2026-08-10
    kind: secondary
    lang: zh-Hant
...
The [C341](/rail/rolling-stock/c341/) is a six-car Siemens fleet, 4M2T[^zh-c341],
