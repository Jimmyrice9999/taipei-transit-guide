...
[Neihu Depot](/rail/depots/neihu-depot/) opened in 2009 it took over as the
...
[VAL256](/rail/rolling-stock/val256/) and Innovia APM 256[^zh-muzha-depot] —
so the line's allocation is not a clean one-fleet-per-depot split.
[Neihu Depot](/rail/depots/neihu-depot/) is the Innovia fleet's principal
base.
