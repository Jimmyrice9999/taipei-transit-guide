---
title: G17 HSR Taichung Station
summary: G17 HSR Taichung Station (高鐵臺中站) — stop 18 of 18 on Taichung Metro's Green Line, in 烏日區.
order: 18
line: G
operator: TMRT
updated: 2026-08-23
...
HSR Taichung Station is stop 18 of 18 on the Green Line, and the committed TDX record pairs the code G17 with the Traditional Chinese name 高鐵臺中站.[^tdx-tmrt] TDX places it in 烏日區 at 臺中市烏日區高鐵東一路28號, with a published route chainage of 16.93 km in the selected direction.[^tdx-tmrt] The address is the source-backed siting description used here; no extra catchment boundary is inferred from it.
...
The committed TDX station record places G17 at sequence 18 of the Green Line, in 烏日區, with a published chainage of 16.93 km for the selected direction.[^tdx-tmrt] This is a position in the operator's station order, not a travel-time or distance-between-stations claim; TDX publishes the chainage field but not a timetable for this page.[^tdx-tmrt]
