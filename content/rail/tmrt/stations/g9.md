---
title: G9 Taichung City Hall
summary: G9 Taichung City Hall (市政府) — stop 9 of 18 on Taichung Metro's Green Line, in 西屯區.
order: 9
line: G
operator: TMRT
updated: 2026-08-23
...
Taichung City Hall is stop 9 of 18 on the Green Line, and the committed TDX record pairs the code G9 with the Traditional Chinese name 市政府.[^tdx-tmrt] TDX places it in 西屯區 at 臺中市西屯區文心路二段688號、699號, with a published route chainage of 8.33 km in the selected direction.[^tdx-tmrt] The address is the source-backed siting description used here; no extra catchment boundary is inferred from it.
...
The committed TDX station record places G9 at sequence 9 of the Green Line, in 西屯區, with a published chainage of 8.33 km for the selected direction.[^tdx-tmrt] This is a position in the operator's station order, not a travel-time or distance-between-stations claim; TDX publishes the chainage field but not a timetable for this page.[^tdx-tmrt]
