...
The TDX record gives the paired English and Traditional Chinese names but does not explain the naming decision.[^tdx-tmrt] A naming etymology, commissioning brief or renaming history for G6 is TBC rather than inferred from an English gloss or from the surrounding street names.
