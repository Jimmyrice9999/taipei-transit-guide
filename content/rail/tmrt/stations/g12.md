---
title: G12 Feng-le Park
summary: G12 Feng-le Park (豐樂公園) — stop 13 of 18 on Taichung Metro's Green Line, in 南屯區.
order: 13
line: G
operator: TMRT
updated: 2026-08-23
...
Feng-le Park is stop 13 of 18 on the Green Line, and the committed TDX record pairs the code G12 with the Traditional Chinese name 豐樂公園.[^tdx-tmrt] TDX places it in 南屯區 at 臺中市南屯區文心南路168號, with a published route chainage of 11.62 km in the selected direction.[^tdx-tmrt] The address is the source-backed siting description used here; no extra catchment boundary is inferred from it.
...
The committed TDX station record places G12 at sequence 13 of the Green Line, in 南屯區, with a published chainage of 11.62 km for the selected direction.[^tdx-tmrt] This is a position in the operator's station order, not a travel-time or distance-between-stations claim; TDX publishes the chainage field but not a timetable for this page.[^tdx-tmrt]
