...
The committed TDX station record places G10a at sequence 11 of the Green Line, in 南屯區, with a published chainage of 10.21 km for the selected direction.[^tdx-tmrt] This is a position in the operator's station order, not a travel-time or distance-between-stations claim; TDX publishes the chainage field but not a timetable for this page.[^tdx-tmrt]
