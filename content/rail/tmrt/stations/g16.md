---
title: G16 Wuri
summary: G16 Wuri (烏日) — stop 17 of 18 on Taichung Metro's Green Line, in 烏日區.
order: 17
line: G
operator: TMRT
updated: 2026-08-23
...
Wuri is stop 17 of 18 on the Green Line, and the committed TDX record pairs the code G16 with the Traditional Chinese name 烏日.[^tdx-tmrt] TDX places it in 烏日區 at 臺中市烏日區建國路295號, with a published route chainage of 15.87 km in the selected direction.[^tdx-tmrt] The address is the source-backed siting description used here; no extra catchment boundary is inferred from it.
...
The committed TDX station record places G16 at sequence 17 of the Green Line, in 烏日區, with a published chainage of 15.87 km for the selected direction.[^tdx-tmrt] This is a position in the operator's station order, not a travel-time or distance-between-stations claim; TDX publishes the chainage field but not a timetable for this page.[^tdx-tmrt]
