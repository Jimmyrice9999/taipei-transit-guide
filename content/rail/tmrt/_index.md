...
The [signalling and automation record](/rail/tmrt/technology/signalling/) covers the operator's "fully automatic driverless" claim and the CJ900/CJ907 system-equipment contract behind it — a three-firm consortium and six named subsystems, none of them a branded signalling product any source found names. The [rolling-stock record](/rail/tmrt/rolling-stock/fleet-roster/) covers the same contract's EMU subsystem: a fleet of two-car trainsets, dimensioned precisely by the operator's own FAQ, with no stated manufacturer split or model/series name. The [accessibility record](/rail/tmrt/facilities/accessibility/) covers ten named station facilities from a dedicated operator page — itself confirmed to run to a second page this session's tooling could not retrieve. The [ridership record](/rail/tmrt/operations/ridership/) covers one month's daily figures from the operator's own statistics archive, internally consistent but silent on what exactly is being counted after a PDF font-encoding gap dropped the table's own column headers. The [fare history record](/rail/tmrt/operations/fares/) covers a resident-priced regional season pass spanning four counties and a monthly points subsidy layered on top of a senior concession — while the base single fare stays off the page entirely, the third Taiwan metro operator this project has found the same gap for. The [land development record](/rail/tmrt/projects/joint-development/) covers seven named Green Line station sites with real investors and dated timelines — the case list Kaohsiung's and Taoyuan's equivalent pages both went looking for and could not reach.
