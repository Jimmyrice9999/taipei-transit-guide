---
title: Taoyuan — Guishan YouBike stations
summary: Static YouBike station rows in Taoyuan's Guishan group, with coordinates, capacity and confirmed nearby rail joins.
updated: 2026-08-25
aliases:
  - "YouBike2.0_Multipurpose Gymnasium of NTSU"
  - "YouBike2.0_國立體育大學綜合體育館"
facts:
  - label: Municipality
    value: Taoyuan
...
This page lists 1 static TDX station rows in Taoyuan's Guishan group, with a published capacity total of 41 docks. TDX's Station/City feed supplies identity, bilingual names, addresses, coordinates and capacity; that feed does not carry current occupancy [^tdx-bike-stations].
...
Representative rows in this group are station ID 500311021 (41 docks; YouBike2.0_國立體育大學綜合體育館) [^tdx-bike-stations]. They remain rows in a browse index because the source provides a compact identity, address, coordinate and capacity record; creating a separate article for every dock would repeat the same source fields without adding a sourced history or design record [^tdx-bike-stations].
...
|---|---:|---|---|---|
| YouBike2.0_Multipurpose Gymnasium of NTSU / YouBike2.0_國立體育大學綜合體育館 [^tdx-bike-stations] | 41 [^tdx-bike-stations] | 25.03599, 121.38504 [^tdx-bike-stations] | [Map](https://www.openstreetmap.org/?mlat=25.035994&mlon=121.38504#map=19/25.035994/121.38504) | — |
