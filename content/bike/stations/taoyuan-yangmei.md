---
title: Taoyuan — Yangmei YouBike stations
summary: Static YouBike station rows in Taoyuan's Yangmei group, with coordinates, capacity and confirmed nearby rail joins.
updated: 2026-08-25
aliases:
  - "YouBike2.0_Fugang Junior High School"
  - "YouBike2.0_富岡國中"
facts:
  - label: Municipality
    value: Taoyuan
...
This page lists 1 static TDX station rows in Taoyuan's Yangmei group, with a published capacity total of 14 docks. TDX's Station/City feed supplies identity, bilingual names, addresses, coordinates and capacity; that feed does not carry current occupancy [^tdx-bike-stations].
...
Representative rows in this group are station ID 500309023 (14 docks; YouBike2.0_富岡國中) [^tdx-bike-stations]. They remain rows in a browse index because the source provides a compact identity, address, coordinate and capacity record; creating a separate article for every dock would repeat the same source fields without adding a sourced history or design record [^tdx-bike-stations].
...
|---|---:|---|---|---|
| YouBike2.0_Fugang Junior High School / YouBike2.0_富岡國中 [^tdx-bike-stations] | 14 [^tdx-bike-stations] | 24.94219, 121.07397 [^tdx-bike-stations] | [Map](https://www.openstreetmap.org/?mlat=24.94219&mlon=121.07397#map=19/24.94219/121.07397) | — |
