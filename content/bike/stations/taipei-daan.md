---
title: Taipei — Daan YouBike stations
summary: Static YouBike station rows in Taipei's Daan group, with coordinates, capacity and confirmed nearby rail joins.
updated: 2026-08-25
aliases:
  - "YouBike2.0_NTU 6th Men's Dorm"
  - "YouBike2.0_臺大男六舍前"
facts:
  - label: Municipality
    value: Taipei
...
This page lists 1 static TDX station rows in Taipei's Daan group, with a published capacity total of 40 docks. TDX's Station/City feed supplies identity, bilingual names, addresses, coordinates and capacity; that feed does not carry current occupancy [^tdx-bike-stations].
...
Representative rows in this group are station ID 500101033 (40 docks; YouBike2.0_臺大男六舍前) [^tdx-bike-stations]. They remain rows in a browse index because the source provides a compact identity, address, coordinate and capacity record; creating a separate article for every dock would repeat the same source fields without adding a sourced history or design record [^tdx-bike-stations].
...
|---|---:|---|---|---|
| YouBike2.0_NTU 6th Men's Dorm / YouBike2.0_臺大男六舍前 [^tdx-bike-stations] | 40 [^tdx-bike-stations] | 25.01664, 121.54520 [^tdx-bike-stations] | [Map](https://www.openstreetmap.org/?mlat=25.01664&mlon=121.5452#map=19/25.01664/121.5452) | — |
