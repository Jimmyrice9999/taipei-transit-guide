...
This page lists 2 static TDX station rows in Taoyuan's Taoyuan group, with a published capacity total of 51 docks. TDX's Station/City feed supplies identity, bilingual names, addresses, coordinates and capacity; current occupancy is not part of this page [^tdx-bike-stations].
