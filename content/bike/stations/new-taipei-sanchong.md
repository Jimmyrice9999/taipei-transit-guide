---
title: New Taipei — Sanchong YouBike stations
summary: Static YouBike station rows in New Taipei's Sanchong group, with coordinates, capacity and confirmed nearby rail joins.
updated: 2026-08-25
aliases:
  - "YouBike2.0_Xiang Yu Twin Towers"
  - "YouBike2.0_翔譽雙子星"
facts:
  - label: Municipality
    value: New Taipei
...
Representative rows in this group are station ID 500203030 (36 docks; YouBike2.0_翔譽雙子星) [^tdx-bike-stations]. They remain rows in a browse index because the source provides a compact identity, address, coordinate and capacity record; creating a separate article for every dock would repeat the same source fields without adding a sourced history or design record [^tdx-bike-stations].
...
|---|---:|---|---|---|
| YouBike2.0_Xiang Yu Twin Towers / YouBike2.0_翔譽雙子星 [^tdx-bike-stations] | 36 [^tdx-bike-stations] | 25.05364, 121.49292 [^tdx-bike-stations] | [Map](https://www.openstreetmap.org/?mlat=25.05364&mlon=121.49292#map=19/25.05364/121.49292) | — |
