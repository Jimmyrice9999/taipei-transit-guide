...
This page lists 1 static TDX station rows in Taipei's Zhongzheng group, with a published capacity total of 40 docks. TDX's Station/City feed supplies identity, bilingual names, addresses, coordinates and capacity; current occupancy is not part of this page [^tdx-bike-stations].
