---
title: New Taipei — Shulin YouBike stations
summary: Static YouBike station rows in New Taipei's Shulin group, with coordinates, capacity and confirmed nearby rail joins.
updated: 2026-08-25
aliases:
  - "YouBike2.0_St. Weiwang"
  - "YouBike2.0_味王街"
facts:
  - label: Municipality
    value: New Taipei
...
This page lists 1 static TDX station rows in New Taipei's Shulin group, with a published capacity total of 26 docks. TDX's Station/City feed supplies identity, bilingual names, addresses, coordinates and capacity; that feed does not carry current occupancy [^tdx-bike-stations].
...
Representative rows in this group are station ID 500231021 (26 docks; YouBike2.0_味王街) [^tdx-bike-stations]. They remain rows in a browse index because the source provides a compact identity, address, coordinate and capacity record; creating a separate article for every dock would repeat the same source fields without adding a sourced history or design record [^tdx-bike-stations].
...
|---|---:|---|---|---|
| YouBike2.0_St. Weiwang / YouBike2.0_味王街 [^tdx-bike-stations] | 26 [^tdx-bike-stations] | 24.97470, 121.40400 [^tdx-bike-stations] | [Map](https://www.openstreetmap.org/?mlat=24.9747&mlon=121.404#map=19/24.9747/121.404) | — |
