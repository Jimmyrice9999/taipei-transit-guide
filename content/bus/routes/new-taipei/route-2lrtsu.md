...
The committed TDX snapshot carries 2 directional or variant stop sequences for Linkou-MRT Fuzhong Station; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**Linkou-MRT Fuzhong Station (12 stops):** Wenhua 3rd & Zhongshan Intersection -> Chuncheng Lichi -> Fudou Community -> LinkouJuniorHighSchool -> National Archives -> Zhongxiao Rd Entrance B -> Linkou Mitsui Outlet Park -> Andun Community -> MRT Xinpu Sta -> Chihlee University of Technology -> Banqiao Rail Sta(Wenhua Rd) -> MRT Fuzhong Station(Fuzhong Rd)[^tdx-bus]

**Linkou-MRT Fuzhong Station(Renai Rd) (12 stops):** Wenhua 3rd & Zhongshan Intersection -> Chuncheng Lichi -> Renai & Donghu Intersection -> Linkou High School -> SportsPark(Renai Rd) -> Kongjiian Park Community -> Linkou Mitsui Outlet Park -> Andun Community -> MRT Xinpu Sta -> Chihlee University of Technology -> Banqiao Rail Sta(Wenhua Rd) -> MRT Fuzhong Station(Fuzhong Rd)[^tdx-bus]
