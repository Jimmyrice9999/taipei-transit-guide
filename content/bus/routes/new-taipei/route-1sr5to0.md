---
title: "L-B Frog / 林口-板橋"
summary: "New Taipei route: L-B Frog (林口-板橋)."
updated: 2026-08-19
facts:
  - label: Service class
...
The committed TDX snapshot carries 1 directional or variant stop sequence for L-B Frog; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**L-B Frog (20 stops):** Linkou Stop -> Glory of the fature -> Wenhua 3rd & Zhongshan Intersection -> ChunchengLichi -> Fudou Community -> LinkouJuniorHighSchool -> Kongjiian Park Community -> ShimaoFanglin -> Linkou Mitsui Outlet Park -> Andun Community -> Changping St Entrance -> Touqian Junior High School -> MRT Xingfu Sta -> Taipei Hospital -> MRT Touqianzhuang(Siyuan Rd) -> MRT Xinpu Sta -> Chihlee University of Technology -> Banqiao Rail Sta(Wenhua Rd) -> Wanping Park -> MRT Fuzhong Station(Fuzhong Rd)[^tdx-bus]
