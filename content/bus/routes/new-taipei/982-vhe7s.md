---
title: "982Exp.S / 982直達新埔線"
summary: "New Taipei route: 982Exp.S (982直達新埔線)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 一般公車 dataset files 982直達新埔線 as a General bus (一般公車) identity.[^ntpc-category-general]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 3 stops from 捷運新埔站, past 捷運頭前庄站(思源路), ending at 行政院新莊聯合辦公大樓(榮華).[^tdx-bus] 3 confirmed interchanges are recorded in the curated stop-ID join set: Xinpu, Touqianzhuang and Xinpu Minsheng.[^tdx-bus] The route runs 2 subroutes under two operators, 首都客運 and 大都會客運.[^tdx-bus] The TDX record files 2 distinct stop-pattern names under this identity: 982直達新埔線捷運新埔站、982直達新埔線行政院新莊聯合辦公大樓(榮華).[^tdx-bus] The committed record carries 2 direction/variant sequences, 6 distinct stops in total: 3 stops (outbound, 982直達新埔線捷運新埔站); 3 stops (return, 982直達新埔線行政院新莊聯合辦公大樓(榮華)).[^tdx-bus] The published fare is charged over 1 segments; the published route length is 10.6 km; weekday service runs from 07:20 to 19:00.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “捷運新埔站-行政院新莊聯合辦公大樓”; published distance 10.6 km; service span Weekdays: 去程：0720-1900；返程：0720-1900; Holidays: 去程： - ；返程： -; fare 一段票 / 1 segments.[^ntpc-bus-route-data]

## Committed stop sequence

The committed TDX snapshot carries 2 directional or variant stop sequences for 982Exp.S; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**982 ExpS MRT Xinpu Sta (3 stops):** MRT Xinpu Sta -> MRT Touqianzhuang  Sta (Siyuan Rd) -> Xinzhuang Joint Office Tower, Executive Yuan (Ronghua)[^tdx-bus]

**982 ExpS Xinzhuang Joint Office Tower,Executive Yuan(Ronghua) (3 stops):** Xinzhuang Joint Office Tower, Executive Yuan (Ronghua) -> MRT Touqianzhuang Sta(Siyuan Rd) -> MRT Xinpu Sta[^tdx-bus]
