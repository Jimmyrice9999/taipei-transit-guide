---
title: "F821 / F821"
summary: "New Taipei route: F821 (F821)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F821 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 12 stops from 平溪, past 外店, then 白鶯橋, then 南山社區, then 十分寮橋, then 十分風景區, then 新寮, ending at 新寮大厝.[^tdx-bus] The curated stop-ID join set records no confirmed MRT interchange on this route.[^tdx-bus] The route runs 2 subroutes under a single operator, 平溪區公所.[^tdx-bus] The TDX record files 2 distinct stop-pattern names under this identity: F821平溪、F821新寮.[^tdx-bus] The committed record carries 2 direction/variant sequences, 24 distinct stops in total: 12 stops (outbound, F821平溪); 12 stops (return, F821新寮).[^tdx-bus] The published fare is charged over Free; the published route length is recorded as 99 km, a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset and treated here as an unpopulated placeholder rather than a measured distance for this specific route; weekday service runs from 07:30 to 17:10; holiday service follows the same published span.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “平溪-新寮大厝”; published distance 99 km (a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset, which reads as an unpopulated placeholder rather than a measured distance for this specific route); service span Weekdays: 去程：0730-1710；返程：0755-1740; Holidays: 去程：0730-1710；返程：0755-1740; fare 免費 / Free.[^ntpc-bus-route-data]
