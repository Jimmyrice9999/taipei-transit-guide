---
title: "925 / 925"
summary: "New Taipei route: 925 (925)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 快速公車 dataset files 925 as a Rapid bus (快速公車) identity.[^ntpc-category-rapid]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 47 stops from 林口站, past 人見仁愛社區(仁愛路), then 林口, then 運動公園, then 文化二路一段郵局, then 建和新村, then 民族路口, ending at 捷運蘆洲站.[^tdx-bus] 4 confirmed interchanges are recorded in the curated stop-ID join set: Sanhe Junior High School, St.lgnatius High School, Sanmin Senior High School and Luzhou.[^tdx-bus] The route runs 5 subroutes under a single operator, 臺北客運.[^tdx-bus] The TDX record files 3 distinct stop-pattern names under this identity: 925厚德派出所、925林口站(車機)、925.[^tdx-bus] The committed record carries 5 direction/variant sequences, 82 distinct stops in total: 15 stops (outbound, 925厚德派出所); 35 stops (return, 925厚德派出所); 47 stops (outbound, 925林口站(車機)); 47 stops (outbound, 925); 35 stops (return, 925).[^tdx-bus] The published fare is charged over 2 segments; the published route length is 54 km; weekday service runs from 05:00 to 22:00, with a published peak headway of 1520 minutes and 2030 minutes off-peak; holiday service instead runs from 05:30 to 22:00.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “林口-蘆洲”; published distance 54 km; service span Weekdays: 去程：0500-2200；返程：0500-2200; Holidays: 去程：0530-2200；返程：0530-2200; headway fields Weekdays: weekday peak 1520; weekday off-peak 2030; Holidays: holiday peak 2030; holiday off-peak 2030; fare 二段票 / 2 segments.[^ntpc-bus-route-data]
