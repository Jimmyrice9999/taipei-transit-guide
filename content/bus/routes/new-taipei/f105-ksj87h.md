---
title: "F105 / F105"
summary: "New Taipei route: F105 (F105)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F105 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence is a there-and-back working of 84 stops from 捷運淡水站, past 永樂巷口(中山市場), then 頂田寮路口, then 石頭公, then 彩色世界, then 大牛稠, then 華南銀行, returning to 捷運淡水站.[^tdx-bus] 2 confirmed interchanges are recorded in the curated stop-ID join set: Tamsui and Xinshi 1st Rd..[^tdx-bus] The route runs 5 subroutes under a single operator, 淡水區公所.[^tdx-bus] The TDX record files 5 distinct stop-pattern names under this identity: F105、F105經頂田寮14號、崙頂8號、F105經桂竹圍8號、F105經頂田寮14號、桂竹圍8號、崙頂8號、F105經頂田寮14號、桂竹圍8號.[^tdx-bus] The committed record carries 5 direction/variant sequences, 84 distinct stops in total: 80 stops (outbound, F105); 82 stops (outbound, F105經頂田寮14號、崙頂8號); 82 stops (outbound, F105經桂竹圍8號); 84 stops (outbound, F105經頂田寮14號、桂竹圍8號、崙頂8號); 83 stops (outbound, F105經頂田寮14號、桂竹圍8號).[^tdx-bus] The published route length is recorded as 99 km, a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset and treated here as an unpopulated placeholder rather than a measured distance for this specific route; weekday service runs from 05:50 to 20:30; holiday service follows the same published span.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “捷運淡水站-華南銀行”; published distance 99 km (a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset, which reads as an unpopulated placeholder rather than a measured distance for this specific route); service span Weekdays: 去程：0550-2030；返程：0550-2030; Holidays: 去程：0550-2030；返程：0550-2030.[^ntpc-bus-route-data]
