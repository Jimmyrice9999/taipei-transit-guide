---
title: "860 / 860"
summary: "New Taipei route: 860 (860)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 一般公車 dataset files 860 as a General bus (一般公車) identity.[^ntpc-category-general]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 47 stops from 三芝, past 古庄, then 佛朗明哥, then 夏威夷社區, then 義山里, then 新市一路, then 華南銀行, ending at 捷運淡水站.[^tdx-bus] 4 confirmed interchanges are recorded in the curated stop-ID join set: Tamsui, Danjin Beixin, Xinshi 1st Rd. and Tamsui District Office.[^tdx-bus] The route runs 4 subroutes under a single operator, 淡水客運.[^tdx-bus] The TDX record files 3 distinct stop-pattern names under this identity: 860、860三芝站(車機)、860捷運淡水站(車機).[^tdx-bus] The committed record carries 4 direction/variant sequences, 92 distinct stops in total: 47 stops (outbound, 860); 45 stops (return, 860); 47 stops (outbound, 860三芝站(車機)); 45 stops (return, 860捷運淡水站(車機)).[^tdx-bus] The published fare is charged over Charge for 2 sections; the published route length is 34.3 km; weekday service runs from 05:40 to 22:30, with a published peak headway of 0812 minutes and 2530 minutes off-peak; holiday service follows the same published span.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “三芝-捷運淡水站”; published distance 34.3 km; service span Weekdays: 去程：0540-2230；返程：0540-2230; Holidays: 去程：0540-2230；返程：0540-2230; headway fields Weekdays: weekday peak 0812; weekday off-peak 2530; 21:45班次配合867區間車僅行駛至捷運淡水站，自捷運淡水站於22:00後班距為30-60分; Holidays: holiday peak 2530; holiday off-peak 2530; 21:40班次配合867區間車僅行駛至捷運淡水站，自捷運淡水站於22:00後班距為30-60分; fare 二段票 / Charge for 2 sections.[^ntpc-bus-route-data]
