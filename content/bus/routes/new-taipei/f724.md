...
The full New Taipei route-service row publishes endpoints “坪林國中-厚德岡坑”; published distance 99 km; service span Weekdays: 去程： - ；返程： -; Holidays: 去程：0900-1600；返程：0900-1600; headway fields Holidays: 請參照簡圖時刻表.[^ntpc-bus-route-data]
