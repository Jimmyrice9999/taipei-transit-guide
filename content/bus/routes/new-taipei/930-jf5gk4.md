...
The committed TDX snapshot carries 2 directional or variant stop sequences for 930Extend; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].
