---
title: "Shimen-MRT Hongshulin Sta. / 石門-捷運紅樹林站"
summary: "New Taipei route: Shimen-MRT Hongshulin Sta. (石門-捷運紅樹林站)."
updated: 2026-08-19
facts:
  - label: Service class
...
The committed TDX snapshot carries 2 directional or variant stop sequences for Shimen-MRT Hongshulin Sta.; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**853 Jumping Frog Bus A Sub (14 stops):** Shimen District office -> Shimen -> Mackay Memorial Hospital -> Xinshui Juyi -> Sanzhi -> Beishixi Intersection -> Linzi -> St John‘s University -> Xiaguiroushan -> Linzi -> Beixin Rd Entrance -> LRT Ganzhenlin Sta -> MRT Hongshulin Sta -> Zhuwei High School[^tdx-bus]

**853Frog2 (13 stops):** Shimen District office -> Shimen -> Mackay Memorial Hospital -> Xinshui Juyi -> Sanzhi -> Beishixi Intersection -> Linzi -> St John‘s University -> Xiaguiroushan -> Linzi -> Beixin Rd Entrance -> LRT Ganzhenlin Sta -> MRT Hongshulin Sta[^tdx-bus]
