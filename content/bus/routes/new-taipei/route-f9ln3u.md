---
title: "linkou-MRT Zhongxiao Dunhua Station / 林口-捷運忠孝敦化站"
summary: "New Taipei route: linkou-MRT Zhongxiao Dunhua Station (林口-捷運忠孝敦化站)."
updated: 2026-08-19
facts:
  - label: Service class
...
The committed TDX snapshot carries 1 directional or variant stop sequence for linkou-MRT Zhongxiao Dunhua Station; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**linkou-MRT Zhongxiao Dunhua Station (14 stops):** Taipei Sindou -> Linkou High School -> Renai & Donghu Intersection -> Zhulin & Renai Intersection -> Touhu Rd Entrance -> Chunghwa Telecom Co,Ltd -> ShangpinCommunity -> Sports Park -> Farmers Association Branch -> FreewayBureau -> Xingtian Temple -> Minquan and Fuxing Intersection -> Songshan Airport -> Zhongxiao & Dunhua Intersection[^tdx-bus]
