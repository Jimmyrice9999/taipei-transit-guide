---
title: "Beta Community - MRT Dingpu Sta. / 北大社區-捷運頂埔站"
summary: "New Taipei route: Beta Community - MRT Dingpu Sta. (北大社區-捷運頂埔站)."
updated: 2026-08-19
facts:
  - label: Service class
...
The committed TDX snapshot carries 1 directional or variant stop sequence for Beta Community - MRT Dingpu Sta.; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**Beta Community - MRT Dingpu Sta (10 stops):** Guniang Temple -> Dacheng Rd -> Shinrin Park -> Ocean Park -> Xuechin Rd -> Nat'l Taipei U (Main Gate) -> Daxue and Xuecheng Rd Intersection -> Long Pu Elementary School -> MRT Hengxi Sta -> MRT Dingpu Sta[^tdx-bus]
