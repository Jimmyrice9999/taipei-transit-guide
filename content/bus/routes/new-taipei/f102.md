---
title: "F102 / F102"
summary: "New Taipei route: F102 (F102)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F102 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence is a there-and-back working of 69 stops from 捷運淡水站, past 永樂巷口(中山市場), then 紅柿仔腳, then 大埤頭, then 大湖橋, then 顏厝, then 華南銀行, returning to 捷運淡水站.[^tdx-bus] 2 confirmed interchanges are recorded in the curated stop-ID join set: Tamsui and Danjin Beixin.[^tdx-bus] The route runs 8 subroutes under a single operator, 淡水區公所.[^tdx-bus] The TDX record files 8 distinct stop-pattern names under this identity: F102、F102反向經鄒厝崙、F102經淡水商工、F102經淡水商工、鄒厝崙、F102經鄒厝崙、F102經市民農園、F102經鄒厝崙、市民農園、F102反向經鄒厝崙、市民農園.[^tdx-bus] The committed record carries 8 direction/variant sequences, 137 distinct stops in total: 64 stops (outbound, F102); 65 stops (return, F102反向經鄒厝崙); 58 stops (outbound, F102經淡水商工); 61 stops (outbound, F102經淡水商工、鄒厝崙); 67 stops (outbound, F102經鄒厝崙); 66 stops (outbound, F102經市民農園); 69 stops (outbound, F102經鄒厝崙、市民農園); 67 stops (return, F102反向經鄒厝崙、市民農園).[^tdx-bus] The published route length is recorded as 99 km, a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset and treated here as an unpopulated placeholder rather than a measured distance for this specific route; weekday service runs from 05:30 to 21:40; holiday service follows the same published span.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “捷運淡水站-華南銀行”; published distance 99 km (a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset, which reads as an unpopulated placeholder rather than a measured distance for this specific route); service span Weekdays: 去程：0530-2140；返程：2140-2140; Holidays: 去程：0530-2140；返程： -.[^ntpc-bus-route-data]
