---
title: "F213 / F213"
summary: "New Taipei route: F213 (F213)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F213 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence is a there-and-back working of 22 stops from 泰山公有市場, past 福泰里, then 泰山國中, then 大科路63號, then 自強路37號, returning to 泰山公有市場.[^tdx-bus] The curated stop-ID join set records no confirmed MRT interchange on this route.[^tdx-bus] The route runs 2 subroutes under a single operator, 泰山區公所.[^tdx-bus] The TDX record files 2 distinct stop-pattern names under this identity: F213、F213第一班.[^tdx-bus] The committed record carries 2 direction/variant sequences, 22 distinct stops in total: 22 stops (outbound, F213); 11 stops (outbound, F213第一班).[^tdx-bus] The published route length is recorded as 99 km, a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset and treated here as an unpopulated placeholder rather than a measured distance for this specific route; weekday service runs from 05:50 to 17:25; holiday service instead runs from 06:20 to 16:50.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “泰山公有市場-勝隆土雞城”; published distance 99 km (a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset, which reads as an unpopulated placeholder rather than a measured distance for this specific route); service span Weekdays: 去程：0550-1725；返程：0550-1725; Holidays: 去程：0620-1650；返程：0620-1650; headway fields Weekdays: 第一班勝隆土雞城發車; Holidays: 第一班勝隆土雞城發車.[^ntpc-bus-route-data]
