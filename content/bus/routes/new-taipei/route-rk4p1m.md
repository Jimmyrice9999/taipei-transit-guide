---
title: "MRT Qizhang station-Global Industrial Area / 捷運七張站-全球工業區"
summary: "New Taipei route: MRT Qizhang station-Global Industrial Area (捷運七張站-全球工業區)."
updated: 2026-08-19
facts:
  - label: Service class
...
The committed TDX snapshot carries 2 directional or variant stop sequences for MRT Qizhang station-Global Industrial Area; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**MRT Qizhang station-Global Industrial Area Go (4 stops):** MRT Qizhang Sta -> Far Eastern Century -> Quanqiu Industrial Office -> MRT Qizhang Sta[^tdx-bus]

**MRT Qizhang station-Global Industrial Area Back (4 stops):** Far Eastern Century -> Quanqiu Industrial Office -> MRT Qizhang Sta -> Far Eastern Century[^tdx-bus]
