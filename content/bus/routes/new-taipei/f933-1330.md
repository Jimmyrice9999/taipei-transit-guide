---
title: "F933-1330 / F933-1330"
summary: "New Taipei route: F933-1330 (F933-1330)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F933-1330 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
...
The committed TDX snapshot carries 1 directional or variant stop sequence for F933-1330; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**F933-1330 (13 stops):** Jinshan District Office -> Jinshan Police Sta -> Fengyu -> Shanwei -> Huanggang Rd -> Huanggang -> Sheliao -> Jinshan Youth Activity Center -> Jinshan Police Sta -> JinShan -> Jinshan District Office -> Nanshihu Rd -> Jinshan Hospital[^tdx-bus]
