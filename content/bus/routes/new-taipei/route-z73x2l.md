---
title: "LINKOU(Wenhua N. Rd.)-MRT Yuanshan Station / 林口(文化北路)-捷運圓山站"
summary: "New Taipei route: LINKOU(Wenhua N. Rd.)-MRT Yuanshan Station (林口(文化北路)-捷運圓山站)."
updated: 2026-08-19
facts:
  - label: Service class
...
The committed TDX snapshot carries 1 directional or variant stop sequence for LINKOU(Wenhua N. Rd.)-MRT Yuanshan Station; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**Linkou(Wenhua N Rd)-MRT Yuanshan Sta (14 stops):** Taipei School of Special Education(Jiatianxia Community) -> Zhongfu Rd & Nanshi 1st St Intersection -> Zhongfu Rd & Nanshi 3rd St Intersection -> Thumb Convenience Store -> Nanshi Elementary School -> FutureFamilyCommunity -> Zhucheng Songhe Community -> Jingquan Park -> FutureTownCommunity -> Administrative Park -> Linkou MRT station -> FreewayBureau -> Taipei School for the Hearing Impaired -> MRT Yuanshan Station (Yuanshan Transfer Station)[^tdx-bus]
