...
The full New Taipei route-service row publishes endpoints “國泰醫院(建成路)-國泰醫院(建成路)”; published distance 99 km; service span Weekdays: 去程：0625-1845；返程：0625-1845; Holidays: 去程：0625-1845；返程：0625-1845.[^ntpc-bus-route-data]
