---
title: "F657 / F657"
summary: "New Taipei route: F657 (F657)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F657 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 20 stops from 昌福國小, past 鶯桃路182巷口, then 福安街口, then 鳳鳴國小, then 鳳福鳳三路口, then 鶯桃路668巷口, then 長庚醫院(分院), ending at 長庚醫院.[^tdx-bus] 2 confirmed interchanges are recorded in the curated stop-ID join set: Yongji Park and Yingtao Fude.[^tdx-bus] The route runs 2 subroutes under a single operator, 鶯歌區公所.[^tdx-bus] The TDX record files 2 distinct stop-pattern names under this identity: F657昌福國小、F657長庚醫院(總院).[^tdx-bus] The committed record carries 2 direction/variant sequences, 37 distinct stops in total: 20 stops (outbound, F657昌福國小); 17 stops (return, F657長庚醫院(總院)).[^tdx-bus] No weekday service is published.[^ntpc-bus-route-data]
...
The committed TDX snapshot carries 2 directional or variant stop sequences for F657; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**F657 Changfu Elementary School (20 stops):** Changfu Elementary School -> Lane 182 Yingtao Rd Intersection -> Yongji St Entrance -> MRT Yongji Park Sta -> Fuan St Entrance -> Yingtao & Fengming Intersection -> MRT Yingtao Fude Sta(Yingtao Rd) -> Fengming Activity Center -> Fengming Elementary School -> Lane 174 Yonghe St -> Fengming Rail Sta -> Fengfu & Feng 3rd Rd Intersection -> Fengfu Park -> No94 Fengji 1st St -> No27 Sec 2 Yingtao Rd -> Lane 668 Yingtao Rd Intersection -> Yingge Rd Entrance -> Tatung Community -> Chang-Gung Memorial Hospital -> Chang-Gung Memorial Hospital[^tdx-bus]

**F657 Chang-Gung Memorial Hospital (17 stops):** Chang-Gung Memorial Hospital -> Chang-Gung Memorial Hospital -> Tatung Community -> Fengming Rail Sta -> Fengfu & Feng 3rd Rd Intersection -> Fengfu Park -> No94 Fengji 1st St -> No27 Sec 2 Yingtao Rd -> Lane 668 Yingtao Rd Intersection -> Jinjin Theater -> MRT Yingtao Fude Sta(Yingtao Rd) -> Fengming St Entrance -> Fuan St Entrance -> MRT Yongji Park Sta -> Yongji St Entrance -> Lane 182 Yingtao Rd Intersection -> Changfu Elementary School[^tdx-bus]
