---
title: "677Sub / 677副"
summary: "New Taipei route: 677Sub (677副)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 一般公車 dataset files 677副 as a General bus (一般公車) identity.[^ntpc-category-general]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 37 stops from 社后消防隊, past 社后派出所, then 樟江大橋, then 金龍里, then 東湖國小, then 大湖公園, then 金龍隧道口, ending at 金龍寺.[^tdx-bus] 3 confirmed interchanges are recorded in the curated stop-ID join set: Neihu, Dahu Park and Huzhou.[^tdx-bus] The route runs 2 subroutes under a single operator, 光華巴士.[^tdx-bus] The committed record carries 2 direction/variant sequences, 73 distinct stops in total: 37 stops (outbound); 36 stops (return).[^tdx-bus] The published fare is charged over 1 Segment; the published route length is 21 km; weekday service runs from 06:15 to 17:40.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “汐止社后-金龍寺”; published distance 21 km; service span Weekdays: 去程：0615-1740；返程：0615-1740; Holidays: 去程： - ；返程： -; fare 一段票 / 1 Segment.[^ntpc-bus-route-data]

## Committed stop sequence

The committed TDX snapshot carries 2 directional or variant stop sequences for 677Sub; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**677 Sub (37 stops):** Shehou Fire Brigade -> Shehou Police Station -> Gongjian Rd -> Shuidu Community -> Jhangshu International Creative Technical High School -> Houde Village -> Fuan Temple -> Zhangjiang Bridge 2 -> Zhangjiang Bridge -> Bojue Village -> Fude 1st Rd Entrance -> Duke Villa (I) -> BinHuDaDi -> Jinlonghu -> Hudong St Entrance -> Jinlong Villiage -> Beifong Village(Mingfong St) -> Jinlong Elementary School(Mingfong St) -> Munan Coal Mine -> Economic & Trade Park -> Beishan Village -> Donghu Elementary School -> Wufen Community -> Minghu Junior High School -> Minghu Elementary School (PTS) -> MRT Huzhou Sta (University of Kang Ning) -> Kangning Hospital -> Huangshigong Temple -> Dahu Park -> MRT Dahu Park Sta -> Dahu -> Jinlong Village -> Jinlong Rd Entrance -> Maoshang Village 3 -> Bihu Elementary School (Jinlong) -> Jinlong Tunnel Entrance -> Jinlong Temple[^tdx-bus]

**677 Sub (36 stops):** Jinlong Tunnel Entrance -> Bihu Elementary School (Jinlong) -> Maoshang Village 3 -> Jinlong Rd Entrance -> Xiuhu -> Dahu -> MRT Dahu Park Sta -> Dahu Park -> Huangshigong Temple -> Kangning Hospital -> Kangning Community -> MRT Huzhou Sta (University of Kang Ning) -> Minghu Elementary School (PTS) -> Wufen Community -> Donghu Elementary School -> Beishan Village -> Economic & Trade Park -> Munan Coal Mine -> Jinlong Elementary School(Mingfong St) -> Jinlong Villiage -> Hudong St Entrance -> Jinlonghu -> BinHuDaDi -> Bojue Village(1) -> Fude 1st Rd Entrance -> Bojue Village -> Zhangjiang Bridge -> Zhangjiang Bridge 2 -> Fuan Temple -> Houde Village -> Jhangshu International Creative Technical High School -> Shuidu Community -> Gongjian Rd -> Zhongxing Rd -> Shehou Police Station -> Shehou Fire Brigade[^tdx-bus]
