---
title: "F922naikan / F922內崁"
summary: "New Taipei route: F922naikan (F922內崁)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F922內崁 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 30 stops from 萬里區公所, past 萬里北基路口, then 二坑路口, then 五坑, then 香員林橋, then 黃厝, then 靈泉寺, ending at 瑞泉路口.[^tdx-bus] The curated stop-ID join set records no confirmed MRT interchange on this route.[^tdx-bus] The route runs 2 subroutes under a single operator, 萬里區公所.[^tdx-bus] The TDX record files 2 distinct stop-pattern names under this identity: F922內崁萬里區公所、F922內崁靈泉寺.[^tdx-bus] The committed record carries 2 direction/variant sequences, 55 distinct stops in total: 30 stops (outbound, F922內崁萬里區公所); 25 stops (return, F922內崁靈泉寺).[^tdx-bus] The published route length is recorded as 99 km, a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset and treated here as an unpopulated placeholder rather than a measured distance for this specific route; weekday service runs from 12:50 to 17:05; holiday service follows the same published span.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “萬里區公所-靈泉寺”; published distance 99 km (a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset, which reads as an unpopulated placeholder rather than a measured distance for this specific route); service span Weekdays: 去程：1250-1705；返程：0630-1900; Holidays: 去程：1250-1705；返程：0630-1900.[^ntpc-bus-route-data]

## Committed stop sequence

The committed TDX snapshot carries 2 directional or variant stop sequences for F922naikan; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**F922Naikan Wanli District office (30 stops):** Wanli District office -> Wanli Beiji Intersection -> Zhongfu Temple -> Zhongfu Bridge -> Gucuo -> Liukeng -> Erkeng Rd Entrance -> Erkeng -> Tudigong Temple -> Jinghukou -> Wheelchair Factory -> Sanchang -> Wukeng -> Kanjiao Police Station -> Kanjiao Elementary School -> Tudigong Temple -> Xiangyuanlin Entrance -> Xiangyuanlin Bridge -> Fudekeng -> Fudekeng Bridge -> Daping Elementary School Xidi Campus -> Chencuo -> Zou Family House -> Huangcuo -> Mazu Temple -> Xucuo -> Xidi Bridge No3 -> Bei 28 & Bei 28 & 2 Intersection -> Lingquan Temple -> Ruiquan Rd Entrance[^tdx-bus]

**F922Naikan Lingquan Temple (25 stops):** Lingquan Temple -> Bei 28 & Bei 28 & 2 Intersection -> Zhangcuo -> Zoucuo -> No21 Fushiping -> Tongcuo -> No6 Wututan Rd Entrance -> Wucuo Rd Entrance -> Guocuo Rd Entrance -> Yuda Bridge -> Kanjiao Elementary School -> Kanjiao Police Station -> Wukeng -> Sanchang -> Wheelchair Factory -> Jinghukou -> Tudigong Temple -> Erkeng -> Erkeng Rd Entrance -> Liukeng -> Gucuo -> Zhongfu Bridge -> Zhongfu Temple -> Wanli Beiji Intersection -> Wanli District office[^tdx-bus]
