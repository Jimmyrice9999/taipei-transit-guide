---
title: "F629 / F629"
summary: "New Taipei route: F629 (F629)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F629 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence is a there-and-back working of 87 stops from 三峽國小(三峽國民運動中心), past 三峽國中一, then 海一(二), then 田寮站, then 安新站一, then 成福活動中心, then 三峽老街(復興路), returning to 三峽國小(三峽國民運動中心).[^tdx-bus] The curated stop-ID join set records no confirmed MRT interchange on this route.[^tdx-bus] The route runs 2 subroutes under a single operator, 三峽區公所.[^tdx-bus] The TDX record files 2 distinct stop-pattern names under this identity: F629延駛四份仔、F629.[^tdx-bus] The committed record carries 2 direction/variant sequences, 87 distinct stops in total: 87 stops (outbound, F629延駛四份仔); 78 stops (outbound, F629).[^tdx-bus] The published route length is recorded as 99 km, a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset and treated here as an unpopulated placeholder rather than a measured distance for this specific route; weekday service runs from 06:15 to 17:30; holiday service instead runs from 06:15 to 18:30.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “文化停車場-鹿母潭”; published distance 99 km (a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset, which reads as an unpopulated placeholder rather than a measured distance for this specific route); service span Weekdays: 去程：0615-1730；返程：0615-1730; Holidays: 去程：0615-1830；返程：0615-1830; headway fields Weekdays: 每日06:15 11:15二班次加行駛路線-安新站、四份仔; Holidays: 06:15 11:15 11:25(星期日)班次加行駛路線-安新站、四份仔.[^ntpc-bus-route-data]
