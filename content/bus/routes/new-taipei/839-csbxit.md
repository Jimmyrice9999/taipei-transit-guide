---
title: "839Gengxin / 839耕莘"
summary: "New Taipei route: 839Gengxin (839耕莘)."
updated: 2026-08-19
facts:
  - label: Service class
...
The committed TDX snapshot carries 2 directional or variant stop sequences for 839Gengxin; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**839 Gengxin (31 stops):** Erbazi Botanical Garden -> Daguan A6 Stop -> Daguan A7 Stop -> Daguan A5 Stop -> Daguan A4 Stop -> Daguan A2 Stop -> Daguan Clubhouse -> Daguan A1 Stop -> Bulao Restaurant -> Activity Center -> LRT Cardinal Tien Hospital An Kang Branch Sta(Chezi Rd) -> Ankang Chezi Rd Intersection -> Taipei Tobacco Factory -> Langmanguizu -> Gonglun New Village(Feng Rong Hospital) -> Ankang Police Station -> Guanghua New Village(Ankang Rd) -> Anwar Rd Entrance -> Xiacheng Community -> Mansion of General Hu-Lien -> Dingcheng -> Dapingding -> Xitou -> Bitan Bridge -> Binlang Rd Entrance -> MRT Xindian City Hall Sta(Beixin) -> Qizhang(Beixin Rd) -> MRT Qizhang Sta -> Minzu & Beixin Intersection -> Dafeng Elementary School -> Minzu Rd Entrance(Cardinal Tien Hospital)[^tdx-bus]

**839 Gengxin (30 stops):** Zhongzheng Public Housing -> Chongguang High School -> Zhongzheng Rd Entrance -> MRT Xindian District Office Station -> Binlang Rd Entrance -> Bitan Bridge -> Xitou -> Dapingding -> Dingcheng -> Mansion of General Hu-Lien -> Xiacheng Community -> Anwar Rd Entrance -> Guanghua New Village(Ankang Rd) -> Ankang Police Station -> Gonglun New Village(Feng Rong Hospital) -> Langmanguizu -> Taipei Tobacco Factory -> Chezi Rd Entrance -> LRT Cardinal Tien Hospital An Kang Branch Sta(Chezi Rd) -> Activity Center -> Bulao Restaurant -> Daguan A1 Stop -> Daguan A3 Stop -> Daguan Clubhouse -> Daguan A2 Stop -> Daguan A4 Stop -> Daguan A5 Stop -> Daguan A7 Stop -> Daguan A6 Stop -> Erbazi Botanical Garden[^tdx-bus]
