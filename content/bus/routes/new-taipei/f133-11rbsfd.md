---
title: "F133last time / F133末班"
summary: "New Taipei route: F133last time (F133末班)."
updated: 2026-08-19
facts:
  - label: Service class
...
The committed TDX snapshot carries 1 directional or variant stop sequence for F133last time; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**F133 moban (10 stops):** No2 Warehouse -> Putoukeng -> Baxian Activity Center -> Mujiliao -> Houdian -> Jinmu Temple -> Houdian -> Fude 15 Stop -> Neighborhood 7 Fude -> Sanzhi Junior High School[^tdx-bus]
