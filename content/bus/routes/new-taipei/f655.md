---
title: "F655 / F655"
summary: "New Taipei route: F655 (F655)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F655 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 13 stops from 鶯歌區公所, past 林長壽圖書館, then 中山路292號, then 大湖路148號, then 鶯歌幼兒園, then 中湖街70號, then 長庚醫院(分院), ending at 長庚醫院.[^tdx-bus] The curated stop-ID join set records no confirmed MRT interchange on this route.[^tdx-bus] The route runs 2 subroutes under a single operator, 鶯歌區公所.[^tdx-bus] The TDX record files 2 distinct stop-pattern names under this identity: F655鶯歌區公所、F655長庚醫院(總院).[^tdx-bus] The committed record carries 2 direction/variant sequences, 25 distinct stops in total: 13 stops (outbound, F655鶯歌區公所); 12 stops (return, F655長庚醫院(總院)).[^tdx-bus] No weekday service is published.[^ntpc-bus-route-data]
...
The committed TDX snapshot carries 2 directional or variant stop sequences for F655; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**F655Yingge District Office (13 stops):** Yingge District Office -> Lin Chang Shou Library -> Lane 249 Zhongshan Rd -> No292 Zhongshan Rd -> Yucuo Lane Entrance -> No148 Dahu Rd -> Minghu Community -> Yingge preschool -> No358 Dahu Rd -> No70 Zhonghu St -> Dazhuwei -> Chang-Gung Memorial Hospital -> Chang-Gung Memorial Hospital[^tdx-bus]

**F655Chang-Gung Memorial Hospital (12 stops):** Chang-Gung Memorial Hospital -> Chang-Gung Memorial Hospital -> Dazhuwei -> No70 Zhonghu St -> Yingge preschool -> Minghu Community -> No148 Dahu Rd -> Yucuo Lane Entrance -> No292 Zhongshan Rd -> Lane 249 Zhongshan Rd -> Lin Chang Shou Library -> Yingge District Office[^tdx-bus]
