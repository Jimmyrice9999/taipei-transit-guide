---
title: "264 / 264"
summary: "New Taipei route: 264 (264)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 一般公車 dataset files 264 as a General bus (一般公車) identity.[^ntpc-category-general]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 53 stops from 歡仔園, past 僑中一街, then 捷運江子翠站, then 中山藝術公園, then 捷運三和國中站, then 民族路口, ending at 捷運蘆洲站.[^tdx-bus] 12 confirmed interchanges are recorded in the curated stop-ID join set: Sanchong Station, Fuzhong, Banqiao, Xinpu, Jiangzicui, Longshan Temple, Cailiao, Sanchong, Sanchong Elementary School, Sanhe Junior High School, St.lgnatius High School and Luzhou.[^tdx-bus] The route runs 4 subroutes under a single operator, 臺北客運.[^tdx-bus] The TDX record files 3 distinct stop-pattern names under this identity: 264、264歡仔園、264捷運蘆洲站.[^tdx-bus] The committed record carries 4 direction/variant sequences, 112 distinct stops in total: 53 stops (outbound, 264); 59 stops (return, 264); 53 stops (outbound, 264歡仔園); 59 stops (return, 264捷運蘆洲站).[^tdx-bus] The published fare is charged over Charge for 1 sections; the published route length is 44.2 km; weekday service runs from 05:00 to 22:00, with a published peak headway of 0812 minutes and 1220 minutes off-peak; holiday service follows the same published span.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “板橋-捷運蘆洲站”; published distance 44.2 km; service span Weekdays: 去程：0500-2200；返程：0500-2200; Holidays: 去程：0500-2200；返程：0500-2200; headway fields Weekdays: weekday peak 0812; weekday off-peak 1220; Holidays: holiday peak 15; holiday off-peak 20; fare 一段票 / Charge for 1 sections.[^ntpc-bus-route-data]
