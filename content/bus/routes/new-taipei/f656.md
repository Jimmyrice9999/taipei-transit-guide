---
title: "F656 / F656"
summary: "New Taipei route: F656 (F656)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F656 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence is a there-and-back working of 42 stops from 鶯歌火車站, past 南鶯國慶115巷口, then 建國路與鶯桃路口, then 昌福國小, then 福安街口, then 鳳鳴活動中心, then 鳳福鳳三路口, then 鶯桃路二段27號, then 鳳鳴街口, then 鶯桃路285巷41號, returning to 鶯歌火車站.[^tdx-bus] 2 confirmed interchanges are recorded in the curated stop-ID join set: Yongji Park and Yingtao Fude.[^tdx-bus] The route runs 1 subroute under a single operator, 鶯歌區公所.[^tdx-bus] The committed record carries 1 direction/variant sequence, 42 distinct stops in total: 42 stops (outbound).[^tdx-bus] No weekday service is published.[^ntpc-bus-route-data]
...
The committed TDX snapshot carries 1 directional or variant stop sequence for F656; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**F656 (42 stops):** Yingge Rail Sta -> Nanying Ln 115 Guoqing St Entrance -> No3 Park Nanxing Temple -> Tongqing Village Activity Center -> Yingge Junior High School -> Jianguo & Yingtao Intersection -> Yongchang Village -> Farmers Association(Yongchang Village) -> Changfu Elementary School -> Lane 182 Yingtao Rd Intersection -> Yongji St Entrance -> MRT Yongji Park Sta -> Fuan St Entrance -> Yingtao & Fengming Intersection -> MRT Yingtao Fude Sta(Yingtao Rd) -> Fengming Activity Center -> Fengming Elementary School -> Lane 174 Yonghe St -> Fengming Rail Sta -> Fengfu & Feng 3rd Rd Intersection -> Fengfu Park -> No94 Fengji 1st St -> No27 Sec 2 Yingtao Rd -> Lane 668 Yingtao Rd Intersection -> Jinjin Theater -> MRT Yingtao Fude Sta(Yingtao Rd) -> Fengming St Entrance -> Fuan St Entrance -> Yongji Elementary School -> No41 Lane 285 Yingtao Rd -> MRT Yongji Park Sta -> Yongji St Entrance -> Lane 182 Yingtao Rd Intersection -> Changfu Elementary School -> Farmers Association(Yongchang Village) -> Yongchang Village -> Jianguo & Yingtao Intersection -> Yingge Junior High School -> Tongqing Village Activity Center -> No3 Park Nanxing Temple -> Nanying Ln 115 Guoqing St Entrance -> Yingge Rail Sta[^tdx-bus]
