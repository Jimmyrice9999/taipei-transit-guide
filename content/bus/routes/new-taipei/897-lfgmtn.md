---
title: "897Shuttle / 897區"
summary: "New Taipei route: 897Shuttle (897區)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 一般公車 dataset files 897區 as a General bus (一般公車) identity.[^ntpc-category-general]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 23 stops from 景文科技大學, past 台貿八村, then 輕軌安康站, then 輕軌陽光運動公園站, then 永平里, then 景新街, then 景新街口, ending at 捷運景安站.[^tdx-bus] 4 confirmed interchanges are recorded in the curated stop-ID join set: Ankang, Sunshine Sports Park, Xinhe Elementary School and Jingan.[^tdx-bus] The route runs 2 subroutes under a single operator, 指南客運.[^tdx-bus] The committed record carries 2 direction/variant sequences, 41 distinct stops in total: 23 stops (outbound); 18 stops (return).[^tdx-bus] The published fare is charged over 1 segments; the published route length is 12.7 km; weekday service runs from 06:50 to 21:00.[^ntpc-bus-route-data]
