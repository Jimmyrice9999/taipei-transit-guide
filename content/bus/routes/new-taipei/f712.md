...
The full New Taipei route-service row publishes endpoints “深坑國小校門口-大崙尾”; published distance 99 km; service span Weekdays: 去程：0750-1500；返程：0750-1500; Holidays: 去程： - ；返程： -.[^ntpc-bus-route-data]
