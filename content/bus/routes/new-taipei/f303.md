---
title: "F303 / F303"
summary: "New Taipei route: F303 (F303)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F303 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence is a there-and-back working of 39 stops from 三重區公所(新北大道), past 大同公園, then 二重國小, then 下竹圍街34號, then 碧華街273號, then 溪尾街口, then 明志國中, returning to 三重區公所(新北大道).[^tdx-bus] 1 confirmed interchange is recorded in the curated stop-ID join set: St.lgnatius High School.[^tdx-bus] The route runs 1 subroute under a single operator, 三重區公所.[^tdx-bus] The committed record carries 1 direction/variant sequence, 39 distinct stops in total: 39 stops (outbound).[^tdx-bus] The published route length is recorded as 99 km, a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset and treated here as an unpopulated placeholder rather than a measured distance for this specific route; weekday service runs from 06:20 to 17:00.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “三重區公所-明志國中”; published distance 99 km (a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset, which reads as an unpopulated placeholder rather than a measured distance for this specific route); service span Weekdays: 去程：0620-1700；返程：0620-1700; Holidays: 去程： - ；返程： -.[^ntpc-bus-route-data]

## Committed stop sequence

The committed TDX snapshot carries 1 directional or variant stop sequence for F303; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**F303 (39 stops):** Sanchong City Office(New Taipei Blvd) -> Tatung Park -> No57 Sec 1 Lixing Rd -> No83 Sec 1 Lixing Rd -> Xinhai Gas -> Zhongxiao & Sanmin Intersection -> TungHai Senior High School -> New Taipei Metropolitan Park -> ErChong Elementary School -> Spanish Water World -> Long Zhuang Jieshou -> Chelutou St Entrance -> Lianhua St Entrance -> Yitian Temple -> Yongfu Police Station -> No34 Xiazhuwei St -> No124 Yongfu St -> Yongfu Elementary School -> St Ignatius High School -> BEVERLY Cloth Street -> Meimei New Village -> Cifu Police Station -> Bihua Temple -> No273 Bihua St -> No371 Bihua St -> Mozart community -> Wuhua Village -> Ziqiang & Wuhua Intersection -> Ziqiang Rd Sec 5 -> Renzheng St -> Xiwei St Entrance -> Ziqiang Rd Entrance -> Ger-Jyh Senior High School(Ziqiang Rd) -> Yongde Village -> Houde Elementary School -> Liuzhang St Intersection -> Xiude Elementary School -> Mingzhi Junior High School -> Sanchong City Office(New Taipei Blvd)[^tdx-bus]
