---
title: "Linkou-Taipei / 林口-臺北長庚醫院"
summary: "New Taipei route: Linkou-Taipei (林口-臺北長庚醫院)."
updated: 2026-08-19
facts:
  - label: Service class
...
The committed TDX snapshot carries 1 directional or variant stop sequence for Linkou-Taipei; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**Linkou-Taipei (10 stops):** Hsing Wu University -> Xinyiguobao Community -> Future City Community -> Zhongxiao Rd Entrance -> FutureTownCommunity -> MRT Linkou Station -> Xingtian Temple -> MRT Xingtian Temple Sta (Songjiang Rd) -> Nat'I Taipei U(Taipei Campus) -> Chang-Gung Memorial Hospital[^tdx-bus]
