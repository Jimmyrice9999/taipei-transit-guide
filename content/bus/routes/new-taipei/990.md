...
The committed TDX snapshot carries 2 directional or variant stop sequences for 990; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**990 MRT Tamsui Sta (11 stops):** MRT Tamsui Sta -> JhongJian St Entrance -> Little White House (Danshui Precinct) -> Fort San Domingo (Aletheia University) -> Huwei Cultural and Arts Park(Martyrs' Shrine) -> Tamsui Bus Station -> Bali(Zhongxiao Rd) -> Bali District Administration Center(Shisanhung Museum) -> JiouCheng Village -> Taoyuan Airport Terminal 2 -> Taoyuan Airport Terminal 1[^tdx-bus]

**990 Taoyuan Airport Terminal 1 (11 stops):** Taoyuan Airport Terminal 1 -> Taoyuan Airport Terminal 2 -> JiouCheng Village -> Bali District Administration Center(Shisanhung Museum) -> Bali(Zhongxiao Rd) -> Tamsui Bus Station -> Huwei Cultural and Arts Park(Martyrs' Shrine) -> Fort San Domingo (Aletheia University) -> Little White House (Danshui Precinct) -> Chongjian St Intersection -> MRT Tamsui Sta[^tdx-bus]
