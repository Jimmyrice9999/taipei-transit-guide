---
title: "Xizhi-Taipei101 / 汐止-台北101"
summary: "New Taipei route: Xizhi-Taipei101 (汐止-台北101)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 跳蛙公車 dataset files 汐止-台北101 as a Jump-frog commuter bus (跳蛙公車) identity.[^ntpc-category-jumpfrog]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 10 stops from 摩天鎮, past 崇義高中(忠孝東路), then 汐止後車站, then 連興街口, then 松山高中(基隆路), then 捷運台北101/世貿站(信義), ending at 市政府(市府).[^tdx-bus] 2 confirmed interchanges are recorded in the curated stop-ID join set: Taipei City Hall and Taipei 101/World Trade Center.[^tdx-bus] The route runs 1 subroute under a single operator, 新北客運.[^tdx-bus] The committed record carries 1 direction/variant sequence, 10 distinct stops in total: 10 stops (outbound).[^tdx-bus] The published fare is charged over 2 segment; the published route length is 17.8 km; weekday service runs from 07:00 to 07:20.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “汐止-台北101”; published distance 17.8 km; service span Weekdays: 去程：0700-0720；返程：0700-0720; Holidays: 去程： - ；返程： -; fare 二段票 / 2 segment.[^ntpc-bus-route-data]

## Committed stop sequence

The committed TDX snapshot carries 1 directional or variant stop sequence for Xizhi-Taipei101; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**Xizhi-Taipei101 (10 stops):** Motian Community -> Chongyi Senior High School(Zhongxiao E Rd) -> Modern Family Community -> Xizhi Rail Sta -> Xizhi Administration Center -> Lianxing St Entrance -> Songshan High School (Keelung Rd) -> MRT Taipei City Hall Sta -> MRT Taipei 101 / World Trade Center Sta (XinYi) -> Taipei City Hall[^tdx-bus]
