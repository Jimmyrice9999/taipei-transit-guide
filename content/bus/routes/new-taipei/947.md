---
title: "947 / 947"
summary: "New Taipei route: 947 (947)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 快速公車 dataset files 947 as a Rapid bus (快速公車) identity.[^ntpc-category-rapid]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 57 stops from 新市站, past 勤家捷奏社區, then 大龜崙福德宮, then 華南銀行, then 馬偕醫院, then 五府千歲, then 華翠大橋, ending at 中山國中(縣民大道).[^tdx-bus] 7 confirmed interchanges are recorded in the curated stop-ID join set: Banqiao, Zhuwei, Hongshulin, Tamsui, Tamsui District Office, Danhai New Town and Xinpu Minsheng.[^tdx-bus] The route runs 4 subroutes under two operators, 淡水客運 and 指南客運.[^tdx-bus] The TDX record files 3 distinct stop-pattern names under this identity: 947、947新市站(車機)、947新北板橋公車站(車機).[^tdx-bus] The committed record carries 4 direction/variant sequences, 114 distinct stops in total: 57 stops (outbound, 947); 57 stops (return, 947); 57 stops (outbound, 947新市站(車機)); 57 stops (return, 947新北板橋公車站(車機)).[^tdx-bus] The published fare is charged over Charge for 3 sections; the published route length is 60.6 km; weekday service runs from 05:30 to 22:30, with a published peak headway of 1015 minutes and 1520 minutes off-peak; holiday service follows the same published span.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “淡水-板橋”; published distance 60.6 km; service span Weekdays: 去程：0530-2230；返程：0530-2230; Holidays: 去程：0530-2230；返程：0530-2230; headway fields Weekdays: weekday peak 1015; weekday off-peak 1520; Holidays: holiday peak 30; holiday off-peak 30; fare 三段票 / Charge for 3 sections.[^ntpc-bus-route-data]
