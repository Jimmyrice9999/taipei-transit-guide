---
title: "F652 / F652"
summary: "New Taipei route: F652 (F652)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F652 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence is a there-and-back working of 14 stops from 鶯歌區公所, past 南鶯國慶115巷口, then 文化路140號, then 陶瓷博物館, then 文化路254號, then 三鶯路47號, then 三鶯福德宮, then 恩主公醫院, then 三鶯路47號, then 三鶯福德宮, then 文化路417號, then 文化路351號, then 鶯歌郵局, returning to 鶯歌區公所.[^tdx-bus] The curated stop-ID join set records no confirmed MRT interchange on this route.[^tdx-bus] The route runs 1 subroute under a single operator, 鶯歌區公所.[^tdx-bus] The committed record carries 1 direction/variant sequence, 14 distinct stops in total: 14 stops (outbound).[^tdx-bus] No weekday service is published.[^ntpc-bus-route-data]
...
The committed TDX snapshot carries 1 directional or variant stop sequence for F652; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**F652 (14 stops):** Yingge District Office -> Nanying Ln 115 Guoqing St Entrance -> No140 Wenhua Rd -> No214 Wenhua Rd -> No254 Wenhua Rd -> No47 Yingge Rd -> Sanying Fude Temple -> EnChuKong Hospital -> No47 Yingge Rd -> Sanying Fude Temple -> No417 Wenhua Rd -> No351 Wenhua Rd -> Yingge Post Office -> Yingge District Office[^tdx-bus]
