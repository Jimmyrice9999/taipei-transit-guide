---
title: "897 / 897"
summary: "New Taipei route: 897 (897)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 一般公車 dataset files 897 as a General bus (一般公車) identity.[^ntpc-category-general]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence runs 45 stops from 景文科技大學, past 台貿八村, then 輕軌陽光運動公園站, then 南勢角(景平路), then 保生路口, then 中山錦和路口, then 民權路口, ending at 新北市政府(新府路).[^tdx-bus] 8 confirmed interchanges are recorded in the curated stop-ID join set: Banqiao, Ankang, Sunshine Sports Park, Xinhe Elementary School, Jingan, Yongan Market, Zhonghe and Qiaohe.[^tdx-bus] The route runs 2 subroutes under a single operator, 指南客運.[^tdx-bus] The committed record carries 2 direction/variant sequences, 89 distinct stops in total: 45 stops (outbound); 44 stops (return).[^tdx-bus] The published fare is charged over 2 segments; the published route length is 27 km; weekday service runs from 06:00 to 21:55.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “景文科技大學-板橋”; published distance 27 km; service span Weekdays: 去程：0600-2155；返程：0600-2155; Holidays: 去程： - ；返程： -; fare 二段票 / 2 segments.[^ntpc-bus-route-data]

## Committed stop sequence

The committed TDX snapshot carries 2 directional or variant stop sequences for 897; each sequence below is ordered from its first boarding stop to its last; this is the current data record, not an inferred route history[^tdx-bus].

**897 (45 stops):** Jinwen U of Science and Technology -> Taimao Village 8 -> Anju Civil Service Housing -> Ankeng Elementary School -> Ankang Police Station -> LRT Ankang Sta -> Chi Jen High School -> Shisifen -> Guanghua St Entrance -> LRT Sunshine Sports Park Sta -> Shitoucuo -> Anhe Rd Sec 2 -> Yangguang Park(Anhe Flower Market) -> Yongping Village -> LRT Xinhe Elementary School Sta(Hydraulic building) -> Xinhe Elementary School -> Sanjie Temple -> Jingxin St -> Nanshijiao(Jingping Rd) -> Zhonghe Church -> MRT Jingan Sta -> Jingxin St Entrance -> Anhe Rd Entrance -> Huatai Xincheng -> MRT Yongan Market Sta -> Baoping Rd Entrance -> Baosheng Rd Entrance -> Jiahe Park -> Nanshan High School -> Miaomei Village -> Yijiang New Village -> MRT Zhonghe Sta(Zhongshan Rd) -> Jiamei industrial Area -> Zhonghe Maintenance Plant -> MRT Qiaohe Sta -> Zhongshan & Jinhe Intersection -> Zhongzheng & Zhongshan Intersection -> Jisui -> Banqiao Motor Vehicles Supervision Sta -> Global Mall -> Guotai St Entrance -> Telecommunications Training Center -> Minzu & Quyun Intersection -> Minquan Rd Entrance -> New Taipei City Hall(Xinfu Rd)[^tdx-bus]

**897 (44 stops):** NTPC Banqiao Bus Station -> New Taipei City Hall(Xinfu Rd) -> Minquan Rd Entrance -> Minzu & Quyun Intersection -> Telecommunications Training Center -> Guotai St Entrance -> Global Mall -> Banqiao Motor Vehicles Supervision Sta -> Jisui -> Zhongzheng & Zhongshan Intersection -> Zhongshan & Jinhe Intersection -> MRT Qiaohe Sta -> Zhonghe Maintenance Plant -> Jiamei industrial Area -> MRT Zhonghe Station(Zhongshan Rd) -> Yijiang New Village -> Miaomei Village -> Nanshan High School -> Jiahe Park -> Baosheng Rd Entrance -> Baoping Rd Entrance -> MRT Yongan Market Sta -> Huatai Xincheng -> Anhe Rd Entrance -> Jingxin St Entrance -> MRT Jingan Sta -> Zhonghe Church -> Jingxin St -> Sanjie Temple -> Xinhe Elementary School -> LRT Xinhe Elementary School Sta(Hydraulic building) -> Yongping Village -> Yangguang Park(Anhe Flower Market) -> Anhe Rd Sec 2 -> Shitoucuo -> LRT Sunshine Sports Park Sta -> Guanghua St Entrance -> Shisifen -> Chi Jen High School -> LRT Ankang Sta -> Ankeng Elementary School -> Anju Civil Service Housing -> Taimao Village 8 -> Jinwen U of Science and Technology[^tdx-bus]
