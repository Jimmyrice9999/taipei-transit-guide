---
title: "F103 / F103"
summary: "New Taipei route: F103 (F103)."
updated: 2026-08-19
facts:
  - label: Service class
...
New Taipei City Department of Transportation's full 新巴士 dataset files F103 as a New Bus community service (新巴士) identity.[^ntpc-category-newbus]
The normalized TDX record keeps this route under the New Taipei municipality group and supplies its route identity, current operator records, direction/variant records, stops and geometry.[^tdx-bus]

The confirmed stop sequence is a there-and-back working of 62 stops from 捷運淡水站, past 永樂巷口(中山市場), then 顏厝, then 南勢埔32巷口, then 楓樹湖大溪8號, then 謝厝, then 華南銀行, returning to 捷運淡水站.[^tdx-bus] 2 confirmed interchanges are recorded in the curated stop-ID join set: Tamsui and Danjin Beixin.[^tdx-bus] The route runs 6 subroutes under a single operator, 淡水區公所.[^tdx-bus] The TDX record files 6 distinct stop-pattern names under this identity: F103、F103經瓦窯坑、F103經山仔頂、F103經瓦窯坑、山仔頂、F103經腳後崙、F103經瓦窯坑、山仔頂、腳後崙.[^tdx-bus] The committed record carries 6 direction/variant sequences, 62 distinct stops in total: 54 stops (outbound, F103); 57 stops (outbound, F103經瓦窯坑); 56 stops (outbound, F103經山仔頂); 59 stops (outbound, F103經瓦窯坑、山仔頂); 57 stops (outbound, F103經腳後崙); 62 stops (outbound, F103經瓦窯坑、山仔頂、腳後崙).[^tdx-bus] The published route length is recorded as 99 km, a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset and treated here as an unpopulated placeholder rather than a measured distance for this specific route; weekday service runs from 05:30 to 21:40; holiday service follows the same published span.[^ntpc-bus-route-data]

## Current service data

The full New Taipei route-service row publishes endpoints “捷運淡水站-捷運淡水站”; published distance 99 km (a value shared identically across 175 otherwise unrelated New Taipei routes in this dataset, which reads as an unpopulated placeholder rather than a measured distance for this specific route); service span Weekdays: 去程：0530-2140；返程：0530-2140; Holidays: 去程：0530-2140；返程： -.[^ntpc-bus-route-data]
