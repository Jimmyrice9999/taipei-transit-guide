...
The full official catalogue files 景美-榮總(快) under the service label 快速. That label is recorded as evidence, but it does not map this identity to an existing canonical group, so the route remains unclassified rather than being forced into one.[^ebus-unclassified]
