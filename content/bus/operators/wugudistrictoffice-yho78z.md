---
title: "Wugu District Office — NewTaipei TDX operator record"
summary: "TDX operator record for Wugu District Office in NewTaipei."
updated: 2026-08-18
facts:
  - label: English name
...
The committed TDX pull identifies this page as the operator record for Wugu District Office (五股區公所), with source municipality NewTaipei [^tdx-bus-operator-pull].

TDX publishes the record ID bus-operator-wugudistrictoffice-yho78z, operator code WuguDistrictOffice, operator number 0411, phone (02)2291-6051 ~ 5 and URL http://www.wugu.ntpc.gov.tw for this record [^tdx-bus-operator-pull].
