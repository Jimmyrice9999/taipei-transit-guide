...
facts:
  ...
  - label: TDX operator record ID
    value: "bus-operator-newtaipeibus-prtiek"
    source: tdx-bus-operator-pull
...
The committed TDX pull identifies this page as the operator record for New Taipei Bus Co., Ltd. (新北客運), with source municipality Taipei [^tdx-bus-operator-pull].

TDX publishes the record ID bus-operator-newtaipeibus-prtiek, operator code NewTaipeiBus, operator number 1302, phone 0800-002-277 and URL http://www.csgroup-bus.com.tw for this record [^tdx-bus-operator-pull].
...
- `NH7` / 內科通勤專車7 [^tdx-bus-operator-pull]
- `955` [^tdx-bus-operator-pull]
