---
title: "Banqiao District Office — NewTaipei TDX operator record"
summary: "TDX operator record for Banqiao District Office in NewTaipei."
updated: 2026-08-18
facts:
  - label: English name
...
The committed TDX pull identifies this page as the operator record for Banqiao District Office (板橋區公所), with source municipality NewTaipei [^tdx-bus-operator-pull].

TDX publishes the record ID bus-operator-banqiaodistrictoffice-11jjtvo, operator code BanqiaoDistrictOffice, operator number 0818, phone (02)2968-6911 and URL http://www.banqiao.ntpc.gov.tw for this record [^tdx-bus-operator-pull].
