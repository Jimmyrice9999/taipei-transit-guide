---
title: "Xindian District Office — NewTaipei TDX operator record"
summary: "TDX operator record for Xindian District Office in NewTaipei."
updated: 2026-08-18
facts:
  - label: English name
...
The committed TDX pull identifies this page as the operator record for Xindian District Office (新店區公所), with source municipality NewTaipei [^tdx-bus-operator-pull].

TDX publishes the record ID bus-operator-xindiandistrictoffice-y70bgf, operator code XindianDistrictOffice, operator number 1311, phone (02)2911-2281 and URL http://www.xindian.ntpc.gov.tw for this record [^tdx-bus-operator-pull].
