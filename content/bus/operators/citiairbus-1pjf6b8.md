---
title: "Citiair Bus Co., Ltd. — Taipei TDX operator record"
summary: "TDX operator record for Citiair Bus Co., Ltd. in Taipei."
updated: 2026-08-18
facts:
  - label: English name
    value: "Citiair Bus Co., Ltd."
    source: tdx-bus-operator-pull
  - label: Chinese name
    value: "大有巴士"
    source: tdx-bus-operator-pull
  - label: TDX operator record ID
    value: "bus-operator-citiairbus-1pjf6b8"
    source: tdx-bus-operator-pull
...
The committed TDX pull identifies this page as the operator record for Citiair Bus Co., Ltd. (大有巴士), with source municipality Taipei [^tdx-bus-operator-pull].

TDX publishes the record ID bus-operator-citiairbus-1pjf6b8, operator code CitiairBus, operator number 0302, phone 0800-088-626 and URL http://www.airbus.com.tw for this record [^tdx-bus-operator-pull].
...
- `NH11` / 內科通勤專車11 [^tdx-bus-operator-pull]
- `212Express` / 212直 [^tdx-bus-operator-pull]
- `212Night` / 212夜 [^tdx-bus-operator-pull]
- `212` [^tdx-bus-operator-pull]
- `257` [^tdx-bus-operator-pull]
- `88` [^tdx-bus-operator-pull]
- `88Shuttle` / 88區 [^tdx-bus-operator-pull]
- `BL25` / 藍25 [^tdx-bus-operator-pull]
- `NEIHU GREEN BUS` / 雙園巴士 [^tdx-bus-operator-pull]
- `Beihuan Metro Bus` / 北環幹線 [^tdx-bus-operator-pull]
