---
title: "Royal Bus Co., Ltd. — Taipei TDX operator record"
summary: "TDX operator record for Royal Bus Co., Ltd. in Taipei."
updated: 2026-08-18
facts:
  - label: English name
    value: "Royal Bus Co., Ltd."
    source: tdx-bus-operator-pull
  - label: Chinese name
    value: "皇家客運"
    source: tdx-bus-operator-pull
  - label: TDX operator record ID
    value: "bus-operator-royalbus-1noamcq"
    source: tdx-bus-operator-pull
  ...
  - label: TDX-published URL
    value: "http://www.royalbus.com.tw"
    source: tdx-bus-operator-pull
specs:
  - label: Fleet models
    value: TBC
...
The committed TDX pull identifies this page as the operator record for Royal Bus Co., Ltd. (皇家客運), with source municipality Taipei [^tdx-bus-operator-pull].

TDX publishes the record ID bus-operator-royalbus-1noamcq, operator code RoyalBus, operator number 0908, phone 0800-551-687 and URL http://www.royalbus.com.tw for this record [^tdx-bus-operator-pull].
