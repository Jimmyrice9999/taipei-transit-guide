...
facts:
  ...
  - label: TDX operator record ID
    value: "bus-operator-zhonghedistrictoffice-11tjfkn"
    source: tdx-bus-operator-pull
  - label: TDX operator code
    value: "ZhongheDistrictOffice"
    source: tdx-bus-operator-pull
  ...
  - label: TDX-published URL
    value: "http://www.zhonghe.ntpc.gov.tw"
    source: tdx-bus-operator-pull
specs:
  - label: Fleet models
    value: TBC
...
The committed TDX pull identifies this page as the Zhonghe District Office record (中和區公所) in the NewTaipei source set [^tdx-bus-operator-pull]. TDX gives the record ID bus-operator-zhonghedistrictoffice-11tjfkn, operator code ZhongheDistrictOffice, operator number 0408, phone (02)2248-2688 and published URL http://www.zhonghe.ntpc.gov.tw [^tdx-bus-operator-pull]. Those are fields in a transport-data record; they are not, by themselves, a company-registration extract or proof that the district office owns vehicles [^tdx-bus-operator-pull].
