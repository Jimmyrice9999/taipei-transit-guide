---
title: "KuoKuangBus — NewTaipei TDX operator record"
summary: "TDX operator record for KuoKuangBus in NewTaipei."
updated: 2026-08-18
facts:
  - label: English name
    value: "TBC"
  ...
  - label: TDX operator record ID
    value: "bus-operator-kuokuangbus-z1k94y"
    source: tdx-bus-operator-pull
...
The committed TDX pull identifies this page as the operator record for KuoKuangBus (國光客運), with source municipality NewTaipei [^tdx-bus-operator-pull].

TDX publishes the record ID bus-operator-kuokuangbus-z1k94y, operator code KuoKuangBus, operator number 1101, phone 0800-010-138 and URL http://www.kingbus.com.tw for this record [^tdx-bus-operator-pull].
...
- `578` [^tdx-bus-operator-pull]
- `579` [^tdx-bus-operator-pull]
- `581` [^tdx-bus-operator-pull]
- `582` [^tdx-bus-operator-pull]
- `582 Industrial Dist.` / 582經工業區 [^tdx-bus-operator-pull]
- `583` [^tdx-bus-operator-pull]
- `597` [^tdx-bus-operator-pull]
- `780` [^tdx-bus-operator-pull]
- `781` [^tdx-bus-operator-pull]
- `782` [^tdx-bus-operator-pull]
