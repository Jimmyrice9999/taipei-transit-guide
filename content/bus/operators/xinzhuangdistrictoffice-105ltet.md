...
facts:
  ...
  - label: TDX operator record ID
    value: "bus-operator-xinzhuangdistrictoffice-105ltet"
    source: tdx-bus-operator-pull
  - label: TDX operator code
    value: "XinzhuangDistrictOffice"
    source: tdx-bus-operator-pull
  ...
  - label: Routes in committed pull
    ...
    source: tdx-bus-operator-pull
  - label: TDX phone
    value: "(02)2992-9891#410"
    source: tdx-bus-operator-pull
  - label: TDX-published URL
    value: "http://www.xinzhuang.ntpc.gov.tw"
    source: tdx-bus-operator-pull
specs:
  - label: Fleet models
    value: TBC
...
The committed TDX pull identifies this page as the Xinzhuang District Office record (新莊區公所) in the NewTaipei source set [^tdx-bus-operator-pull]. TDX gives the record ID bus-operator-xinzhuangdistrictoffice-105ltet, operator code XinzhuangDistrictOffice, operator number 1315, phone (02)2992-9891#410 and published URL http://www.xinzhuang.ntpc.gov.tw [^tdx-bus-operator-pull]. Those are fields in a transport-data record; they are not, by themselves, a company-registration extract or proof that the district office owns vehicles [^tdx-bus-operator-pull].
...
- F201 [^tdx-bus-operator-pull]
- F202 [^tdx-bus-operator-pull]
- F205 [^tdx-bus-operator-pull]
