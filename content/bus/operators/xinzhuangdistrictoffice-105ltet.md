---
title: "Xinzhuang District Office — NewTaipei TDX operator record"
summary: "TDX operator record for Xinzhuang District Office in NewTaipei."
updated: 2026-08-18
facts:
  - label: English name
...
The committed TDX pull identifies this page as the operator record for Xinzhuang District Office (新莊區公所), with source municipality NewTaipei [^tdx-bus-operator-pull].

TDX publishes the record ID bus-operator-xinzhuangdistrictoffice-105ltet, operator code XinzhuangDistrictOffice, operator number 1315, phone (02)2992-9891#410 and URL http://www.xinzhuang.ntpc.gov.tw for this record [^tdx-bus-operator-pull].
