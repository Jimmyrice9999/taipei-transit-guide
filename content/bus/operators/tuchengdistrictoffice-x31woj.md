---
title: "Tucheng District Office — NewTaipei TDX operator record"
summary: "TDX operator record for Tucheng District Office in NewTaipei."
updated: 2026-08-18
facts:
  - label: English name
...
The committed TDX pull identifies this page as the operator record for Tucheng District Office (土城區公所), with source municipality NewTaipei [^tdx-bus-operator-pull].

TDX publishes the record ID bus-operator-tuchengdistrictoffice-x31woj, operator code TuchengDistrictOffice, operator number 0306, phone (02)2273-2000 and URL http://www.tucheng.ntpc.gov.tw for this record [^tdx-bus-operator-pull].
