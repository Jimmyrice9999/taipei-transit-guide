---
title: "Shenkeng District Office — NewTaipei TDX operator record"
summary: "TDX operator record for Shenkeng District Office in NewTaipei."
updated: 2026-08-18
facts:
  - label: English name
...
The committed TDX pull identifies this page as the operator record for Shenkeng District Office (深坑區公所), with source municipality NewTaipei [^tdx-bus-operator-pull].

TDX publishes the record ID bus-operator-shenkengdistrictoffice-ygzx5e, operator code ShenkengDistrictOffice, operator number 1109, phone (02)2662-3116 and URL http://www.shenkeng.ntpc.gov.tw for this record [^tdx-bus-operator-pull].
