---
title: Model T electric bus
summary: The Model T electric-bus deployment recorded by New Taipei for San Chung Bus route 857.
updated: 2026-08-23
facts:
  - label: Propulsion
    value: Battery electric
    source: ntpc-electric-857
  - label: Operator in the fetched record
    value: San Chung Bus
    source: ntpc-electric-857
  - label: Route in the fetched record
    value: 857
    source: ntpc-electric-857
  - label: Quantity
    value: 13 buses
...
specs:
  ...
  - label: Passenger capacity
    value: TBC
  - label: Per-bus subsidy
    value: NT$1.5 million
    source: ntpc-electric-857
sources:
...
The fetched primary release does not identify a manufacturer, chassis, body builder, battery capacity, seating/standing capacity or charging standard, so those fields remain TBC. A vehicle approval sheet, tender specification or manufacturer technical data sheet naming this exact Model T deployment would settle them [^ntpc-electric-857].

The page therefore records propulsion, operator, route, quantity, date and subsidy without converting the marketing name “Model T” into an unsupported technical model number [^ntpc-electric-857].
