...
aliases:
  ...
  - Mini Three Links
facts:
  - label: Kinmen–Xiamen terminal pair
    value: Kinmen Shuitou–Xiamen Wutong
    source: mpb-small-three-links
  - label: Kinmen–Quanzhou terminal pair
    value: Kinmen Shuitou–Quanzhou Shijing
    source: mpb-small-three-links
  - label: Matsu–Fuzhou terminal pair
    value: Nangan Fuao–Fuzhou Langqi
    source: mpb-small-three-links
  - label: Matsu–Fuzhou terminal pair
    value: Beigan Baisha–Fuzhou Huangqi
    source: mpb-small-three-links
specs:
  ...
  - label: Kinmen–Quanzhou crossing
    ...
    unit: minutes (approximate)
    source: mpb-small-three-links
  - label: Nangan–Langqi crossing
    value: 90
    unit: minutes (approximate)
    source: mpb-small-three-links
  - label: Beigan–Huangqi crossing
    value: 30
    unit: minutes (approximate)
    source: mpb-small-three-links
...
sources:
  - id: mpb-small-three-links
    ...
    kind: primary
    lang: zh-Hant
    note: The full official sailing page identifies the four route families and publishes approximate crossing times with date-dependent sailing controls.
  - id: mpb-matsu-fixed-2025-2026
    ...
    publisher: Maritime and Port Bureau, Ministry of Transportation and Communications (交通部航港局)
    url: https://www.motcmpb.gov.tw/Information/Detail/aa288da0-6019-46ef-b0d6-bad719614b95?NodeId=543&SiteId=1
    accessed: 2026-09-06
    kind: primary
    lang: zh-Hant
    note: The official information page links the fixed Matsu schedule whose stated validity spans December 2025 through November 2026; it was published in December 2025.
  - id: mpb-cross-strait-operations
...
The official page gives approximate crossing times of about 30 minutes for Kinmen–Xiamen, 60 minutes for Kinmen–Quanzhou, 90 minutes for Nangan–Langqi and 30 minutes for Beigan–Huangqi.[^mpb-small-three-links] These are route descriptions, not a promise that every sailing takes exactly that long. Weather, port controls, vessel assignment and cross-border operating notices can change the usable timetable.
