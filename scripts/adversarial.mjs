...
const CONTENT = path.join(ROOT, 'content', 'rail', 'metro', 'lines')
...
const CASES = [
  /* ---- malformed content ---- */
  {
    ...
    expect: 'clean',
    files: { 'content/rail/metro/lines/zz-empty-body.md': '---\ntitle: Empty Body\nline: BR\n---\n' },
    assert: () => (read('rail/metro/lines/zz-empty-body/index.html') ? null : 'page was not generated'),
  },
  {
    name: 'completely empty file',
    expect: 'clean',
    files: { 'content/rail/metro/lines/zz-empty.md': '' },
    assert: () => {
      const html = read('rail/metro/lines/zz-empty/index.html')
  ...
  },
  {
    ...
    expect: 'build-fails',
    files: { 'content/rail/metro/lines/zz-unterminated.md': '---\ntitle: Unterminated\nline: BR\n\nBody text here.\n' },
    namesFile: 'zz-unterminated',
  },
  {
    name: 'invalid YAML in frontmatter',
    expect: 'build-fails',
    files: { 'content/rail/metro/lines/zz-bad-yaml.md': '---\ntitle: "unclosed\nline: [BR\nfacts: {{{\n---\n\nBody.\n' },
    namesFile: 'zz-bad-yaml',
  },
  {
    name: 'unknown station code in prose',
    expect: 'warns',
    files: { 'content/rail/metro/lines/zz-badcode.md': '---\ntitle: Bad Code\nline: BR\n---\n\nTrains run to BR99 and back.\n' },
    assert: () => {
      const html = read('rail/metro/lines/zz-badcode/index.html')
      if (!html) return 'page was not generated'
  ...
  },
  {
    ...
    expect: 'warns',
    files: { 'content/rail/metro/lines/zz-badline.md': '---\ntitle: Bad Line\nline: ZZ\n---\n\nBody.\n' },
  },
  {
    name: 'spine range referencing unknown stations',
    expect: 'warns',
    files: { 'content/rail/metro/lines/zz-badspine.md': '---\ntitle: Bad Spine\nline: BR\nspine: BR97-BR99\n---\n\nBody.\n' },
  },
  {
    name: 'broken formation syntax',
    expect: 'clean',
    files: { 'content/rail/metro/lines/zz-formation.md': '---\ntitle: Bad Formation\nline: BR\nformation: "=== + + = ="\n---\n\nBody.\n' },
    assert: () => {
      const html = read('rail/metro/lines/zz-formation/index.html')
      if (!html) return 'page was not generated'
      /*
  ...
  },
  {
    ...
    expect: 'clean',
    files: {
      'content/rail/metro/lines/zz-huge.md':
        `---\ntitle: ${'Very '.repeat(400)}Long\nsummary: ${'word '.repeat(3000)}\nline: BR\n---\n\nBody.\n`,
    },
    assert: () => {
      const html = read('rail/metro/lines/zz-huge/index.html')
      if (!html) return 'page was not generated'
  ...
  /* ---- unicode ---- */
  {
    ...
    expect: 'clean',
    files: {
      'content/rail/metro/lines/zz-rtl.md':
        '---\ntitle: "Wenhu ‮ enil uhneW ‬ Line"\nline: BR\n---\n\nBody with ‮ reversed ‬ text.\n',
    },
    assert: () => {
      const html = read('rail/metro/lines/zz-rtl/index.html')
      if (!html) return 'page was not generated'
  ...
  },
  {
     ...
     */
    files: {
      'content/rail/metro/lines/zz-unicode.md':
        '---\ntitle: "Zero‍width é́́́ and 🚇🚊"\nline: BR\n---\n\nThe 文湖線‍線 with emoji 🚇 and combining á́́.\n',
    },
    assert: () => {
      const html = read('rail/metro/lines/zz-unicode/index.html')
      if (!html) return 'page was not generated'
  ...
  },
  {
    ...
    files: {
      ...
      'content/rail/metro/lines/zz-han.md': '---\ntitle: Rare Han\nline: BR\n---\n\nRare: 龘齾靐龗 here.\n',
    },
    assert: ({ output = '' } = {}) => {
  ...
  /* ---- injection ---- */
  {
    ...
    expect: 'warns',
    files: {
      'content/rail/metro/lines/zz-jsurl.md':
        '---\ntitle: JS URL\nline: BR\n---\n\n[click](javascript:alert(1)) and <javascript:alert(2)>\n',
    },
    assert: () => {
      const html = read('rail/metro/lines/zz-jsurl/index.html')
      if (!html) return 'page was not generated'
  ...
  },
  {
    ...
    expect: 'warns',
    files: {
      'content/rail/metro/lines/zz-dataurl.md':
        '---\ntitle: Data URL\nline: BR\n---\n\n![x](data:text/html;base64,PHNjcmlwdD5hbGVydCgxKTwvc2NyaXB0Pg==)\n',
    },
    assert: () => {
      const html = read('rail/metro/lines/zz-dataurl/index.html')
      if (!html) return 'page was not generated'
  ...
  },
  {
    ...
    expect: 'clean',
    files: {
      'content/rail/metro/lines/zz-html.md':
        '---\ntitle: Raw HTML\nline: BR\n---\n\n<script>alert(1)</script>\n\n<img src=x onerror=alert(2)>\n\n<span onmouseover="alert(3)">x</span>\n',
    },
    assert: () => {
      const html = read('rail/metro/lines/zz-html/index.html')
      if (!html) return 'page was not generated'
