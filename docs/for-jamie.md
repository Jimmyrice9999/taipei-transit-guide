...
Added row 117 from the complete operator construction-history PDF. It records
Haikeguan–Badouzi at 0.4 km, with Taiwan Railways Administration as constructor,
2015 in the construction-year field, 2016 in the operation-start year field,
and `復駛` as the explanation; the operator's English column says `Revest
drove`:
`https://www.railway.gov.tw/tra-tip-web/tip/file/6a439dbd-9cee-4d4b-9c4b-215439bffbf5`.

The current operator pages identify Haikeguan 7361 and Badouzi 7362. The
committed TDX SA record places them adjacently at source sequences 1 and 2,
with supplied travelled-distance fields 4.3 km and 4.7 km, a difference of
0.4 km:
...
The exact reopening day, service timetable or operating pattern, surveyed
boundary for the 0.4 km value, contract and completion records, detailed work
scope, and source-defined mapping between the historical and current 0.4 km
records remain TBC. The current operator construction-history HTML was fetched
and does not repeat row 117; that is retained as a coverage difference. The
source's English wording is recorded exactly rather than silently corrected.

### Contradicted the corpus

No prior corpus claim was contradicted. The historical reopening subject is kept
beside, rather than merged into, the current Haikeguan, Badouzi and TDX records.

### Conflicts found

No direct numeric contradiction was found. The historical PDF gives 0.4 km and
subtracting the current TDX SA endpoint fields also gives 0.4 km, but the sources
do not establish identical reference points or measurement purposes. The values
are reported separately and are not treated as proof of one shared boundary.

### Gates

`cite` clean (1,718 content files; 7,580 citations); `research` clean (205
files; 870 checked failures); claims 25,256 sourced/4,495 TBC/0 ASSERTED;
build generated 2,723 static pages and postbuild checked 2,871 pages; 477,795
internal links checked across 2,871 pages with no broken links, unresolved
fragments or orphan pages; links audit 1,924 pages and 752 linkable
destinations; search 1,935; nav 19/19; unit 234/234; accessibility checks
clean; CVD audit reports zero genuine contrast failures. Generated audit
reports were restored after verification; `probes/` remains untracked.
...
Added row 108 from the complete operator construction-history PDF. It records
Chishang–Haiduan at 0.3 km as a single-track subject, with the Railway
Reconstruction Bureau's Eastern Region Engineering Office as constructor, 2012
in the construction-year field, 2013 in the operation-start year field, and
Hualien–Taitung railway electrification engineering as the explanation:
`https://www.railway.gov.tw/tra-tip-web/tip/file/6a439dbd-9cee-4d4b-9c4b-215439bffbf5`.

The current operator pages identify Chishang 6070 and Haiduan 6060. The
committed TDX EL record places them adjacently at source sequences 56 and 57,
with supplied travelled-distance fields 278.4 km and 284.1 km, a difference of
5.7 km:
...
The surveyed 0.3 km boundary, exact construction/electrification/service days,
contract and completion records, work scope, and source-defined mapping to the
current 5.7 km TDX interval remain TBC. The current operator construction-history
HTML was fetched and does not repeat row 108; that is retained as a
coverage difference.

### Contradicted the corpus

No prior corpus claim was contradicted. The historical single-track record is
kept beside, rather than merged into, the current Chishang, Haiduan and TDX
records.

### Conflicts found

The historical PDF gives 0.3 km, while subtracting the current TDX EL endpoint
fields gives 5.7 km. The sources do not establish a common distance boundary
or measurement purpose, so the values are reported separately and are not
averaged.

### Gates

`cite` clean (1,709 content files; 7,513 citations); `research` clean (196
files; 833 checked failures); claims 25,065 sourced/4,495 TBC/0 ASSERTED;
build generated 2,705 static pages and postbuild checked 2,853 pages; 475,671
internal links checked across 2,853 pages with no broken links, unresolved
fragments or orphan pages; links audit 1,915 pages and 743 linkable
destinations; search 1,926; nav 19/19; unit 234/234; accessibility checks
clean; CVD audit reports zero genuine contrast failures. Generated audit
reports were restored after verification; `probes/` remains untracked.
...
Added row 102 from the complete operator construction-history PDF. It records
Longtian–Shanhua at 3.8 km, Taiwan Railways Administration as constructor, 2001
in the construction-year field, 2013 in the operation-start year field, and
<span lang="zh-Hant">曾文溪橋新建</span>, rendered in the operator's English column as
“Zeng-Wun River Bridge new construction”:
`https://www.railway.gov.tw/tra-tip-web/tip/file/6a439dbd-9cee-4d4b-9c4b-215439bffbf5`.

The current operator pages identify station 4150 Longtian and station 4170
Shanhua:
`https://www.railway.gov.tw/tra-tip-web/tip/tip00H/tipH41/viewStaInfo/4150` and
`https://www.railway.gov.tw/tra-tip-web/tip/tip00H/tipH41/viewStaInfo/4170`.
The committed TDX WL record contains Longtian at source sequence 81 and 327.4
km, Baling at sequence 82 and 329.6 km, and Shanhua at sequence 83 and 334.2
km, making a supplied endpoint-field difference of 6.8 km.

### TBC and checked failures

The exact construction, bridge-completion and operation-start days, surveyed
3.8 km boundary, complete Zeng-Wun River Bridge scope, contract and completion
records, before-and-after track inventory, and source-defined mapping to the
current 6.8 km TDX field remain TBC. The current operator route-history HTML was
fetched and does not repeat row 102; that is recorded as a source-coverage
difference, not a reason to remove the PDF record.

### Contradicted the corpus

No prior corpus claim was contradicted. The new historical construction record is
kept beside, rather than merged into, the current Longtian, Baling and Shanhua
station and TDX records.

### Conflicts found

The historical PDF gives 3.8 km, while subtracting the current TDX WL endpoint
fields gives 6.8 km and includes Baling as an intervening member. The values are
reported with their source scopes and are not averaged or treated as one
boundary.

### Gates

`cite` clean (1,703 content files; 7,466 citations); `research` clean (190
files; 804 checked failures); claims 24,936 sourced/4,495 TBC/0 ASSERTED; build
generated 2,693 static pages and postbuild checked 2,841 pages; 474,253
internal links checked across 2,841 pages with no broken links, unresolved
fragments or orphan pages; search 1,920; nav 19/19; unit 234/234; accessibility
checks clean; CVD audit reports zero genuine WCAG contrast failures. Generated
audit reports were restored after verification; `probes/` remains untracked.
...
in the construction-year field, 2013 in the operation-start year field, and
<span lang="zh-Hant">鹽水溪橋新建</span>, rendered in the operator's English column as
“Yan-shui River Bridge new construction”:
`https://www.railway.gov.tw/tra-tip-web/tip/file/6a439dbd-9cee-4d4b-9c4b-215439bffbf5`.

The current operator pages identify station 4190 Xinshi and station 4200
Yongkang:
...
The committed TDX WL record contains Xinshi at source sequence 85 and 341.8 km
and Yongkang at sequence 86 and 346.8 km, making a supplied endpoint-field
difference of 5.0 km.

### TBC and checked failures

The exact construction, bridge-completion and operation-start days, surveyed
2.9 km boundary, complete Yan-shui River Bridge scope, contract and completion
records, before-and-after track inventory, and source-defined mapping to the
current 5.0 km TDX field remain TBC. The current operator route-history HTML was
fetched and does not repeat row 103; that is recorded as a source-coverage
difference, not a reason to remove the PDF record.

### Contradicted the corpus

No prior corpus claim was contradicted. The new historical construction record is
kept beside, rather than merged into, the current Xinshi and Yongkang station and
TDX records.

### Conflicts found

The historical PDF gives 2.9 km, while subtracting the current TDX WL endpoint
fields gives 5.0 km. No current station member intervenes, but the sources do
not establish a common boundary, so the values are not averaged or treated as
one measurement.
