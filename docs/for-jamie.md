...
Part 2 now has 40 researched operator pages and 21 TDX-only records (61 total); Run 81 adds Royal Bus with registration, 1717 route/fare, accessibility, subsidy and compliance evidence.
The remaining 21 are zero-route authority or placeholder records; models and depots still remain.
