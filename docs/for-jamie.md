...
Part 4: shared CITE_DEFINITION_PATTERN now lives in lib/citation-definition.mjs; TypeScript re-exports it and citations.mjs imports it. Node/TS/build behavior unchanged; all gates green, 185/185. Part 5: audited 370 unlinked mentions (not the stale 179), classified 197 citation/reference cases and 169 compound/structured cases to leave plain, and linked the two genuine figure-caption station mentions; audit now 368. Part 6: fresh 491-page build, 125 requested screenshots and 135 bounded render checks; no unambiguous visual defect; all gates green, 185/185. Browser connector unavailable and full browser harness timed out; no content changed.
