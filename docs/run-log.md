...
Built the final 17 identities in the official general-bus category slice:
895–899, 897區, 918區, 958–960, 981–983, 982直達, 982區,
982直達新埔線, and 99. Body prose is 1,978 whitespace-delimited words.
Exact New Taipei route-service rows cover 17/17. The batch has 226 confirmed
geometry-only MRT stop-ID joins, 408 candidates rejected as too far, and 0
ambiguous candidates. Separately filed variants remain distinct records; no
suffix meaning was inferred. Sources are the full TDX snapshot
...
Built 20 identities from the official general-bus category slice: 873經正德
國中, 873, 874–877, 878 and 878區, 879–883, 885, 886區 and 886, and
889–891 and 894. Body prose is 2,309 whitespace-delimited words. Exact New
Taipei route-service rows cover 19/20; the unmatched identity keeps its
service fields TBC. The batch has 175 confirmed geometry-only MRT stop-ID
joins, 305 candidates rejected as too far, and 0 ambiguous candidates.
Separately filed variants remain distinct records; no suffix meaning was
inferred. Sources are the full TDX snapshot (https://tdx.transportdata.tw/),
the full New Taipei general-bus catalogue
(https://data.ntpc.gov.tw/datasets/45572534-e503-4ece-afea-54440bf2624a),
the exact current route-service API
(https://data.ntpc.gov.tw/api/datasets/0ee4e6bf-cee6-4ec8-8fe1-71f544015127/json?size=1000),
and the New Taipei transport-management page
...
including 837副, 837區 and 839耕莘, 842, 843, 845, 846, 847 and 847區, 848,
849 and its separately filed 屈尺社區 identity, and 851, 852 and 854. Body
prose is 2,292 whitespace-delimited words. Exact New Taipei route-service
rows cover 19/20; the unmatched identity keeps its service fields TBC. The
batch has 185 confirmed geometry-only MRT stop-ID joins, 359 candidates
rejected as too far, and 4 ambiguous candidates retained as unconfirmed.
Separately filed variants remain distinct records; no suffix meaning was
inferred. Sources are the full TDX snapshot (https://tdx.transportdata.tw/),
the full New Taipei general-bus catalogue
(https://data.ntpc.gov.tw/datasets/45572534-e503-4ece-afea-54440bf2624a),
...
### New Taipei — general buses, batch 7

Built 20 identities from the official general-bus category slice: 806–811,
813 and 813區, 815–817, 819 and 819副, and 820–827. Body prose is 2,357
whitespace-delimited words. Exact New Taipei route-service rows cover 20/20.
The batch has 157 confirmed geometry-only MRT stop-ID joins, 351 candidates
rejected as too far, and 0 ambiguous candidates. Separately filed variants
remain distinct records; no suffix meaning was inferred. Sources are the full
TDX snapshot (https://tdx.transportdata.tw/), the full New Taipei general-bus
catalogue
(https://data.ntpc.gov.tw/datasets/45572534-e503-4ece-afea-54440bf2624a),
the exact current route-service API
(https://data.ntpc.gov.tw/api/datasets/0ee4e6bf-cee6-4ec8-8fe1-71f544015127/json?size=1000),
...
### New Taipei — general buses, batch 6

Built 20 identities from the official general-bus category slice: 790's two
identities, 791's four identities, 793, the three separately filed 795 Taiwan
Tourist Shuttle identities, 796, 797, 799, 8, 800, 801, 802 and 802區, 803
and 805. Body prose is 2,340 whitespace-delimited words. Exact New Taipei
route-service rows cover 18/20; the two unmatched identities keep their
service fields TBC. The batch has 200 confirmed geometry-only MRT stop-ID
joins, 379 candidates rejected as too far, and 0 ambiguous candidates.
Separately filed and Taiwan Tourist Shuttle identities remain distinct
records; no suffix meaning was inferred. Sources are the full TDX snapshot
(https://tdx.transportdata.tw/), the full New Taipei general-bus catalogue
(https://data.ntpc.gov.tw/datasets/45572534-e503-4ece-afea-54440bf2624a),
the exact current route-service API
...
### New Taipei — general buses, batch 5

Built 20 identities from the official general-bus category slice: 712副,
716 (the Taiwan Tourist Shuttle Crown Northern Coast identity), 731, 760,
778–783, 785, 786 and 786區, 787 and its separately filed 瑞芳工業區
identity, 788's three separately filed identities, and 789 and 789區. Body
prose is 2,285 whitespace-delimited words. Exact New Taipei route-service
rows cover 20/20. The batch has 70 confirmed geometry-only MRT stop-ID joins,
158 candidates rejected as too far, and 0 ambiguous candidates. Separately
filed variants remain distinct records; no suffix meaning was inferred.
Sources are the full TDX snapshot (https://tdx.transportdata.tw/), the full
New Taipei general-bus catalogue
(https://data.ntpc.gov.tw/datasets/45572534-e503-4ece-afea-54440bf2624a),
the exact current route-service API
(https://data.ntpc.gov.tw/api/datasets/0ee4e6bf-cee6-4ec8-8fe1-71f544015127/json?size=1000),
and the New Taipei transport-management page
...
### New Taipei — general buses, batch 4

Built 20 identities from the official general-bus category slice: 640A,
656–658 including 657延, the three separately filed 666 identities, 667,
677 and 677副, 678, and 701–707 including 704區, plus 712. Body prose is
2,388 whitespace-delimited words. Exact New Taipei route-service rows cover
20/20. The batch has 215 confirmed geometry-only MRT stop-ID joins, 565
candidates rejected as too far, and 0 ambiguous candidates. Separately filed
variants remain distinct records; no suffix meaning was inferred. Sources are
the full TDX snapshot (https://tdx.transportdata.tw/), the full New Taipei
general-bus catalogue
(https://data.ntpc.gov.tw/datasets/45572534-e503-4ece-afea-54440bf2624a),
the exact current route-service API
(https://data.ntpc.gov.tw/api/datasets/0ee4e6bf-cee6-4ec8-8fe1-71f544015127/json?size=1000),
and the New Taipei transport-management page
...
### New Taipei — general buses, batch 3

Built 20 identities from the official general-bus category slice: 591–597,
62, 624 and its separately filed 綠野香坡 identity, 629 and its separately
filed 區 identity, 631, 635–640 including the separately filed 638副
identity. Body prose is 2,340 whitespace-delimited words. Exact New Taipei
route-service rows cover 19/20; the unmatched identity keeps its service
fields TBC. The batch has 210 confirmed geometry-only MRT stop-ID joins, 480
candidates rejected as too far, and 0 ambiguous candidates. Separately filed
variants remain distinct records; no suffix meaning was inferred. Sources are
the full TDX snapshot (https://tdx.transportdata.tw/), the full New Taipei
general-bus catalogue
...
### New Taipei — general buses, batch 2

Built 20 identities from the official general-bus category slice: 570–590,
including the separately filed 582經工業區 identity. Body prose is 2,268
whitespace-delimited words. Exact New Taipei route-service rows cover 20/20.
The batch has 65 confirmed geometry-only MRT stop-ID joins, 153 candidates
rejected as too far, and 0 ambiguous candidates. Numbered and separately
filed identities remain distinct records; no variant meaning was inferred.
Sources are the full TDX snapshot (https://tdx.transportdata.tw/), the full
New Taipei general-bus catalogue
(https://data.ntpc.gov.tw/datasets/45572534-e503-4ece-afea-54440bf2624a),
the exact current route-service API
...
### New Taipei — general buses, batch 1

Built the first 20 identities from the official general-bus category slice:
三鶯1線, 115平日, 115, 177瑞芳觀光公車, 179, 三鶯2線(原812), 201, 231,
241, 242, 243, 245, 249, 264, 275, 290副萬和, 290副, 51, 520 and 57.
Body prose is 2,408 whitespace-delimited words. Exact New Taipei
route-service rows cover 20/20. The batch has 224 confirmed geometry-only
MRT stop-ID joins, 524 candidates rejected as too far, and 0 ambiguous
candidates. The 115, 290副 and other separately filed identities remain
distinct records; no variant meaning was inferred. Sources are the full TDX
snapshot (https://tdx.transportdata.tw/), the full New Taipei general-bus
catalogue
(https://data.ntpc.gov.tw/datasets/45572534-e503-4ece-afea-54440bf2624a),
the exact current route-service API
(https://data.ntpc.gov.tw/api/datasets/0ee4e6bf-cee6-4ec8-8fe1-71f544015127/json?size=1000),
...
### New Taipei — New Bus community services, closeout batch 11

Built the final 7 New Bus identities: 貢寮區學生專車, 直潭里線, 福連線,
塗潭假日線, 塗潭平日線, 龍崗線 and 吉林線. Body prose is 814
whitespace-delimited words. Exact New Taipei route-service rows cover 7/7.
The batch has 8 confirmed geometry-only MRT stop-ID joins, 8 candidates
rejected as too far, and 0 ambiguous candidates. The student-service and
local-line identities remain separate TDX records; no eligibility or variant
meaning was inferred without a source. Sources are the full TDX snapshot
(https://tdx.transportdata.tw/), the full New Bus catalogue
...
New Bus subgroup closeout: 207 routes, 23,412 body words, 174/207 exact
route-service rows, and 162 confirmed / 511 rejected / 0 ambiguous
geometry-only MRT candidates. The remaining 33 New Bus identities retain
service-field TBC because the full current New Taipei route-service dataset
has no exact row for them.

### New Taipei — New Bus community services, batch 10

Built 20 route identities from the New Bus category slice 181–200: the final
three F931 time-filed identities, ten F932 time-filed identities, and ten
F933 time-filed identities including the student-service identity. Body prose
is 2,432 whitespace-delimited words. Exact New Taipei route-service rows
cover 3/20; the 17 unmatched identities keep their service fields TBC. The
batch has 0 confirmed, 0 rejected and 0 ambiguous geometry-only MRT
candidates. Time-filed identities remain distinct TDX records; no service
pattern or suffix meaning was inferred from the names. Sources are the full
...
F812, F813, F815 and its separately filed Ling tou identity, F816, F821,
F822, F823 and its separately filed district identity, F825, F835, F836,
F837, F838, F839, F901, F902, F903 and F905. Body prose is 2,300
whitespace-delimited words. Exact New Taipei route-service rows cover 14/20;
the six unmatched identities keep their service fields TBC. The batch has 0
confirmed geometry-only MRT stop-ID joins, 2 candidates rejected as too far,
and 0 ambiguous candidates. Separately filed variants remain distinct TDX
records; no suffix meaning was inferred. Sources are the full TDX snapshot
(https://tdx.transportdata.tw/), the full New Bus catalogue
(https://data.ntpc.gov.tw/datasets/e4c58656-22d1-4bcf-af33-16ca94532a36),
the exact current route-service API
...
### New Taipei — New Bus community services, batch 7

Built 20 route identities from the New Bus category slice 121–140: F657,
F703 and its first-three-services identity, F711, F712, F713, F721, F722,
F723 and its separately filed lower/upper identities, F724, F801, F802, F803,
F805, F806, F807's afternoon and morning identities, and F808. Body prose is
2,257 whitespace-delimited words. Exact New Taipei route-service rows cover
19/20; the unmatched identity keeps its service fields TBC. The batch has 16
confirmed geometry-only MRT stop-ID joins, 42 candidates rejected as too far,
and 0 ambiguous candidates. Separately filed variants remain distinct TDX
records; no suffix meaning was inferred. Sources are the full TDX snapshot
(https://tdx.transportdata.tw/), the full New Bus catalogue
(https://data.ntpc.gov.tw/datasets/e4c58656-22d1-4bcf-af33-16ca94532a36),
...
### New Taipei — New Bus community services, batch 6

Built 20 route identities from the New Bus category slice 101–120: F522,
F523, F525, F526, F611, F623, F625, F626 and its time-filed variant, F627,
F628, F629, F630, F651, F652 and its separately filed extension identity,
F653A, F653B, F655 and F656. Body prose is 2,306 whitespace-delimited
words. Exact New Taipei route-service rows cover 13/20; the seven identities
without an exact current row keep their service fields TBC. The batch has 18
confirmed geometry-only MRT stop-ID joins, 158 candidates rejected as too
far, and 0 ambiguous candidates. Sources are the full TDX snapshot
(https://tdx.transportdata.tw/), the full New Bus catalogue
(https://data.ntpc.gov.tw/datasets/e4c58656-22d1-4bcf-af33-16ca94532a36),
the exact current route-service API
(https://data.ntpc.gov.tw/api/datasets/0ee4e6bf-cee6-4ec8-8fe1-71f544015127/json?size=1000),
...
### New Taipei — New Bus community services, batch 5

Built 20 route identities from the New Bus category slice 81–100: F218,
F233, F235, F236, F237, F238, F239, F250, F301, F302, F303, F304, F312,
F317, F319, F320, F512 and its separately filed variant, F513 and F521.
Body prose is 2,229 whitespace-delimited words. Exact New Taipei
route-service rows cover 20/20. The batch has 51 confirmed geometry-only MRT
stop-ID joins, 133 candidates rejected as too far, and 0 ambiguous
candidates. The F512 variant remains a separate TDX identity; no suffix
meaning was inferred. Sources are the full TDX snapshot
(https://tdx.transportdata.tw/), the full New Bus catalogue
(https://data.ntpc.gov.tw/datasets/e4c58656-22d1-4bcf-af33-16ca94532a36),
the exact current route-service API
(https://data.ntpc.gov.tw/api/datasets/0ee4e6bf-cee6-4ec8-8fe1-71f544015127/json?size=1000),
...
### New Taipei — New Bus community services, batch 4

Built 20 route identities from the New Bus category slice 61–80: F153-0830,
F153-0945, F153-1030, F153-1605, F153-1730, F154, F161, F161-0615, F201,
F202, F205, F206, F207, F211, F212 and its separately filed variants, F213
and its separately filed variant, and F217. Body prose is 2,212 whitespace-
delimited words. Exact New Taipei route-service rows cover 20/20. The batch
has 21 confirmed geometry-only MRT stop-ID joins, 72 candidates rejected as
too far, and 0 ambiguous candidates. Time-suffixed and separately filed
variant identities remain distinct TDX records; no suffix meaning was
inferred. Sources are the full TDX snapshot
(https://tdx.transportdata.tw/), the full New Bus catalogue
(https://data.ntpc.gov.tw/datasets/e4c58656-22d1-4bcf-af33-16ca94532a36),
the exact current route-service API
(https://data.ntpc.gov.tw/api/datasets/0ee4e6bf-cee6-4ec8-8fe1-71f544015127/json?size=1000),
...
石碇高中-捷運忠孝復興站, 瑞芳-松山車站(北客), 石門-捷運紅樹林站,
合宜住宅-捷運亞東醫院站, 中和環河西路-永和仁愛路, 萬里-內湖科技園區,
林口(文化北路)-捷運圓山站 and 五股-板橋. Body prose is 1,161
whitespace-delimited words. Exact New Taipei route-service rows cover 10/10.
The batch has 32 confirmed geometry-only MRT stop-ID joins, 25 candidates
rejected as too far, and 0 ambiguous candidates. Jump-frog is complete at 70
routes; across its four batches, exact service rows cover 68/70 and the join
audit totals 249 confirmed / 272 rejected / 2 ambiguous. Sources are the full
TDX bus snapshot, the full New Taipei 跳蛙公車 dataset, the full New Taipei
route-service API and the New Taipei transport-management page. Unpublished
route history, predecessor/renumbering, dated operator changes, corridor
rationale and eligibility remain TBC.
...
# Run 135 - TRA Western station batch (24 August 2026)

The sixth TRA content unit adds Western Main Line station positions 76–90.
The Western current-page set now covers 90 of the 112 TDX Western members;
the Eastern line landing page and the source-backed system indexes remain in
place. No new source family was introduced and no operational figure was
filled from an unverified secondary lead.
...
# Run 139 - TRA Eastern station batch (24 August 2026)

The tenth TRA content unit adds Eastern Main Line station positions 16–30,
bringing the Eastern station set to 30 pages. The build first caught three
missing content-subset glyphs (岳, 纘 and 睦); `npm run fonts` regenerated the
subset and the final export contains all required Han glyphs.

Sources, conflicts and TBC boundaries remain as recorded in the TRA research
file and Runs 130–138. No secondary source was promoted into content. The
page set still reports only TDX station membership and sequence; it does not
infer stopping patterns, facilities, ridership or historical aliases.
...
# Run 141 - TRA Eastern station batch (24 August 2026)

The twelfth TRA content unit adds Eastern Main Line station positions 46–60,
bringing the Eastern station set to 60 pages. The first build identified one
new content-subset glyph (壠 at Guanshan); regenerating the subset fixed the
postbuild check without weakening it.

Sources, conflicts and TBC boundaries remain as recorded in the TRA research
file and Runs 130–140. No secondary source was promoted into content. These
pages continue to report only verified TDX station membership and sequence;
stopping patterns, facilities, ridership and aliases remain TBC.

Gates: build 2,356 pages, Han subsets complete; cite, research, claims
0 ASSERTED, conflicts check and unit 226/226 all pass. Next: Eastern positions
61–64.

# Run 142 - TRA Eastern station batch (24 August 2026)

The thirteenth TRA content unit completes all 64 Eastern Main Line station
pages with the final four positions. The first postbuild pass found two
content-derived glyph gaps (壠 in the changelog and 卑 at Shanli); regenerating
the subsets resolved both while leaving the checker intact.

Sources, conflicts and TBC boundaries remain as recorded in the TRA research
file and Runs 130–141. No secondary source was promoted into content. The
completed Eastern pages report verified TDX station membership and sequence;
stopping patterns, facilities, ridership and aliases remain TBC.
...
Actions run 384 supplied the actual failure: `Cross-check stated facts` rejected the Purple Line sentence as an unregistered TDX absence claim. The fact checker was matching the `tdx-tmrt` footnote id in raw Markdown as though it were prose, then attaching the later “do not provide” clause to it. The checker now removes footnote references and HTML tags before scanning absence claims; `npm run facts` returns all 17 checks with no contradictions. This narrows the check to reader-visible prose and does not weaken the absence-field verification.

Replacement run 385 passed citations, the root build, unit/regression tests, facts, palette, geometry, accessibility and the full browser verification, which took approximately 67 minutes on CI. It then exposed the next real failure in `Adversarial fixtures`: the two malformed-frontmatter cases exited 1 but the build output did not name `zz-unterminated` or `zz-bad-yaml`. Local reproduction captured the underlying exception — `YAMLException: can not read a block mapping entry...` — from `generate-conflicts-index.mjs` before that script added a file path. The generator now wraps `gray-matter` parse errors as `Could not parse frontmatter in content/rail/metro/lines/<file> — ...`; the complete local adversarial run passes 16/16. Build for Pages and Deploy were skipped by run 385 and await the replacement run.
