...
**Status: implemented for Taipei, New Taipei, Taoyuan, Taichung and Kaohsiung.** A dock is a data
...
The 25 August 2026 local pull produced 1,794 Taipei rows, 1,593 New Taipei
rows, 699 Taoyuan rows, 1,817 Taichung rows and 1,500 Kaohsiung rows, for
7,403 rows and 192,573 published docks in this committed snapshot. The same
pull reports capacities of 50,876, 48,355, 24,214, 38,746 and 30,382
respectively. An earlier 23 August snapshot recorded 1,794 Taipei rows,
1,593 New Taipei rows and 699 Taoyuan rows, for 4,086 rows; an earlier direct
check recorded 1,790, 1,593 and 698 respectively, or 4,081 in total. These
dated snapshots remain published as values; they are not averaged or silently
reconciled. The one-dock Taipei capacity difference and row-count differences
are live dataset changes between retrievals.
...
- `content/bike/stations/taichung.md`
- `content/bike/stations/kaohsiung.md`
...
The current snapshot contains 364 joins from 7,403 bike rows. The rail
candidate registry remains Taipei-region only; Taichung and Kaohsiung are
therefore intentionally not assigned rail joins by this layer.
...
are outside this pull. Published historical counts and growth figures
