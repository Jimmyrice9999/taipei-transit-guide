# Ferry — Taitung island connectivity
...
### Current official island-route gateway

- **The East Coast National Scenic Area Administration currently identifies the Taitung Fugang–Green Island Nanliao ferry as a 50-minute crossing and the Fugang–Orchid Island Kaiyuan ferry as a 120-minute crossing.** **Source:** *Passenger ships*, titleOriginal `客船`, East Coast National Scenic Area Administration, `https://www.eastcoast-nsa.gov.tw/zh-tw/service/ferry/`, PRIMARY, High confidence because the complete official page was fetched on 6 September 2026. Original-language basis: `臺東富岡漁港 ↔ 綠島南寮漁港 50分鐘` and `臺東富岡漁港 ↔ 蘭嶼開元漁港 120分鐘`.
- **The same current official page says Green Island has multiple passenger ships each day, with times changed by weather or tide, and lists Kaixuan, Green Island Star, Uranus and Golden Star/Hengxing contact entries.** **Source:** the same full official page, PRIMARY, High confidence. Original-language basis: `綠島與臺東之間每日有多艘客船行駛，常因天候或海潮改變航行的時間` and the four company entries from lines 180–209.
...
- **Farnlin's current date-specific route calendar displayed no sailing for Taitung–Orchid Island on 7 September 2026.** **Source:** *Farnlin route calendar — Taitung to Orchid Island*, titleOriginal `船班資訊－台東 ⟺ 蘭嶼`, Farnlin Shipping Co., Ltd., `https://www.farnlin.com.tw/calendar_main_routestand.html?date=2026-09-07&mon=&routestand=24&year=`, PRIMARY, High confidence for that operator/date query because the full HTML response was fetched on 7 September 2026. Original-language basis: `查詢日期：2026-09-07` and `今日無船班!`. This is not treated as a route-family suspension notice.

## Conflicts

- The East Coast administration currently prints 120 minutes for the Fugang–Orchid Island crossing, while the existing Orchid Island page retains a 120-minute county figure, a 150-minute operator figure and an administration range of about 2–3 hours. These values are not averaged: they remain a published measurement spread.
- The official East Coast page says Green Island has multiple daily vessels but does not print a stable daily count, while the existing Green Island page retains an operator's five-sailings-each-direction base table and a three-versus-four operator naming conflict. The page-level schedule and the administration-level contact inventory measure different things and are kept separate.
- The county page states that air and ferry services are both available, but neither it nor the East Coast page proves a direct transfer with a published time. The existing pages describe access to the port without claiming a direct airport transfer.
...
- **A complete September 2026 daily sailing matrix for the Orchid Island route** — checked 7 September 2026: the official Farnlin calendar is date-query based and displayed no sailing for 7 September, while the government page directs travellers to operators for seasonal/weather-sensitive times. A single date result cannot establish a month-wide schedule.
...
The existing Green Island and Orchid Island canonical route pages now have current official government-page verification for their route families and port relationships. The next useful evidence would be a dated Maritime and Port Bureau/operator schedule extraction, a primary route-specific weather rule, and a current airport–port timetable; none is invented here.
