# Taiwan Railways Jianan–Taichung Port Construction Record — research findings, 26 August 2026
...
- **The PDF's aligned chronology gives 1973 as construction year and 1974 as operation start; row 45 has no explanation.** Source: the same full operator PDF, PRIMARY, High confidence because row 45 and its aligned continuation were read in the complete document. Original-language basis: `民 國 62 年 1973 民 國 63 年 1974`. The following rows separately carry `添築雙線。 Extended to be double-tracked`, which is not attributed to row 45.
...
## Correction and conflicts between primary presentations

- The previous page draft assigned the 1957/1970 dates and a double-track explanation to PDF row 45. A complete reread shows that row 45 is 1973/1974 with no explanation; the 1957/1970 double-track entries align with rows 43 and 44. This is corrected here rather than preserved as a source conflict.
- The full PDF contains Jianan–Taichung Port as row 45 and supplies the 7.8 km, 1973, 1974 and TRA-constructor record. The current HTML page is a separate operator presentation: it includes the preceding Changhua–Minxiong and Chiayi–Xinshi subjects as rows 23 and 24, then moves to Xinpu–Tongxiao as row 25 and does not list Jianan–Taichung Port. The two primary presentations therefore have different row coverage and numbering. This is preserved as a source conflict, not resolved by choosing one.
...
- **Row-45 explanation, exact day/month and any double-track work** — checked 2026-08-26 in the full construction-history PDF. The row supplies no explanation and only years; neighboring rows' double-track explanations were not assigned to row 45.
...
row-45 construction explanation and relationship between the PDF record and the
current station model. Until then, the 7.8 km Jianan–Taichung Port entry remains
a PDF-recorded historical subject;
