# Taiwan Railways Hualien–Ruisui Reconstruction Record — research findings, 26 August 2026
...
- **The PDF's aligned chronology gives 1992 construction and 2003 operation start, with heavier rail and PC sleepers.** Source: the same full operator PDF, PRIMARY, High confidence because the row and aligned continuation were read together. Original-language basis: `民國 81 年 1992 民國 92 年 2003 舖設重軌、PC枕。`.
...
- The historical row 92 value is 70.5 km and its aligned chronology is 1992/2003; the row's explanation names heavier rail and PC sleepers rather than a complete modern as-built inventory.
...
of the recorded rail and sleeper works. A current as-built and service record would be needed to
