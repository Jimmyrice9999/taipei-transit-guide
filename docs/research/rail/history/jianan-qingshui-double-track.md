...
- **The current TRA construction-history HTML table lists Jianan–Qingshui as a 6.0 km double-track segment.** Source: National Taiwan Railways Corporation, *Railway route construction history*, titleOriginal `臺灣鐵路路線建造史`, publisher `國營臺灣鐵路股份有限公司`, `https://www.railway.gov.tw/tra-tip-web/adr/about-1-5`, PRIMARY, High confidence because the complete current operator HTML page was fetched and read. Original-language basis: `27.甲南 - 清水(雙線)`, `6.0`, `臺灣鐵路管理局`, and `添築雙線`.
...
- **The full operator PDF repeats the subject as row 48 with the same 6.0 km and 1974/1974 chronology.** Source: National Taiwan Railways Corporation / former Taiwan Railways Administration, *Chronological History of Railroad Construction*, titleOriginal `路線修築沿革`, publisher `國營臺灣鐵路股份有限公司／臺灣鐵路管理局`, `https://www.railway.gov.tw/tra-tip-web/tip/file/6a439dbd-9cee-4d4b-9c4b-215439bffbf5`, PRIMARY, High confidence because the complete ten-page PDF was fetched and read. Original-language basis: `48.甲南─清水(雙線) Jianan-Qingshui 6.0`, followed by the aligned `民國六三年 1974 民國六三年 1974 添築雙線` fields.
...
6.0 km, 1974, 1974 and `添築雙線` remain the operator's historical record,
