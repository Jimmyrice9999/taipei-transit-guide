...
- **The PDF's aligned chronology gives 1993 construction and 2004 operation start, with an extension to double track.** Source: the same full operator PDF, PRIMARY, High confidence because the row and aligned continuation were read together. Original-language basis: `民 國 82 年 1993 民 國 93 年 2004 添築雙線。`.
...
- The historical row 94 value is 36.7 km and its aligned chronology is 1993/2004; the row's explanation names extension to double track rather than a complete modern as-built inventory.
...
of double-track works. A current as-built and service record would be needed to say more
