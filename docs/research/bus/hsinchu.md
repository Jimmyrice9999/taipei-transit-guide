...
### Fare evidence with explicit scope

- **The current Hsinchu Bus operator route-information page displays NT$15 full fare and NT$8 half fare for the selected Blue 1 zone route.** **Source:** [Hsinchu city-bus route information](https://www.hcbus.com.tw/big5/information-2.asp), original title `新竹市區公車`, PRIMARY, High confidence because the full page was fetched on 2026-09-07. Original-language basis: `票價： 全票：15元/半票：8元`. The page is route-specific and is not generalized to the county or every route category.
- **The full Route 9 fare-table PDF lists one-section full/student/half fares of NT$15/12/8 and two-section fares of NT$30/24/16.** **Source:** [Hsinchu County Route 9 bus fare table](https://bulletinboard.nycu.edu.tw/api/files/20250800075/%E9%99%84%E4%BB%B61-%E5%BF%AB%E6%8D%B79%E8%99%9F%E7%A5%A8%E5%83%B9%E8%A1%A8.pdf), original title `新竹縣快捷9號公車票價表`, Hsinchu County Government document attachment hosted by National Yang Ming Chiao Tung University, PRIMARY document evidence, High confidence because the one-page PDF was fetched and read in full on 2026-09-07. Original-language basis: the full/student/half tables headed `新竹縣快捷9號公車票價表(全票)`, `(半票)` and `(學生票)` and the listed `15`, `30`, `8`, `16`, `12` and `24` values. The table has no effective date printed in the extracted page, so the content identifies it as a retrieved Route 9 fare table rather than a timeless county tariff.
...
- **The linked national route-level fare endpoint** — Checked 2026-09-07: representative full requests to `http://web.taiwanbus.tw/eBUS/subsystem/ticket/TMSquery.aspx?run_id=8590` and its HTTPS form returned HTTP 403. The fare links remain in the structured snapshot, but no amount is inferred from the failed fetch.

## Stated gaps

- Remaining current numeric fares and concession rules: city Blue 1 and Route 9 now have scoped official fare evidence, but the portal returns a fare URL without embedding amounts in the route-detail response. Full route-level fare records and effective dates for the remaining categories would settle the gap.
