...
Researched 22 August 2026. Subject: 石碇區公所 / 石碇區公所; TDX record bus-operator-16476-eglll3.

## What is established

### TDX record identity and route scope

- **Claim.** The committed TDX bus pull identifies bus-operator-16476-eglll3 as the 石碇區公所 / 石碇區公所 record in the NewTaipei source set, with operator code TBC, operator number TBC, phone (02)2663-1080 and URL TBC.
...
- **Original-language sentence.** The repository's TDX operator row contains `id: bus-operator-16476-eglll3`, `names.zh_tw: 石碇區公所`, `operatorId: 16476`, `operatorNo: TBC`, `phone: (02)2663-1080`, and `sourceCities: [NewTaipei]`.
...
- **Original-language sentence.** The committed route data contains 0 route objects whose `operatorIds` array includes `bus-operator-16476-eglll3`.
