# 蘆洲區公所 / Luzhou District Office — operator research
...
Researched 22 August 2026. Subject: 蘆洲區公所 / Luzhou District Office; TDX record bus-operator-luzhoudistrictoffice-yrnsxy.

## What is established

### TDX record identity and route scope

- **Claim.** The committed TDX bus pull identifies bus-operator-luzhoudistrictoffice-yrnsxy as the Luzhou District Office / 蘆洲區公所 record in the NewTaipei source set, with operator code LuzhouDistrictOffice, operator number 2001, phone (02)2281-1484 and URL http://www.luzhou.ntpc.gov.tw.
...
- **Original-language sentence.** The repository's TDX operator row contains `id: bus-operator-luzhoudistrictoffice-yrnsxy`, `names.zh_tw: 蘆洲區公所`, `operatorId: 16237`, `operatorNo: 2001`, `phone: (02)2281-1484`, and `sourceCities: [NewTaipei]`.
...
- **Original-language sentence.** The committed route data contains 4 route objects whose `operatorIds` array includes `bus-operator-luzhoudistrictoffice-yrnsxy`.
