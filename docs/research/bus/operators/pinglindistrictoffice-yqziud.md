# 坪林區公所 / Pinglin District Office — operator research
...
Researched 22 August 2026. Subject: 坪林區公所 / Pinglin District Office; TDX record bus-operator-pinglindistrictoffice-yqziud.

## What is established

### TDX record identity and route scope

- **Claim.** The committed TDX bus pull identifies bus-operator-pinglindistrictoffice-yqziud as the Pinglin District Office / 坪林區公所 record in the NewTaipei source set, with operator code PinglinDistrictOffice, operator number 0811, phone (02)2665-7251 and URL http://www.pinglin.ntpc.gov.tw.
...
- **Original-language sentence.** The repository's TDX operator row contains `id: bus-operator-pinglindistrictoffice-yqziud`, `names.zh_tw: 坪林區公所`, `operatorId: 16247`, `operatorNo: 0811`, `phone: (02)2665-7251`, and `sourceCities: [NewTaipei]`.
...
- **Original-language sentence.** The committed route data contains 6 route objects whose `operatorIds` array includes `bus-operator-pinglindistrictoffice-yqziud`.
