# 永和區公所 / Yonghe District Office — operator research
...
Researched 22 August 2026. Subject: 永和區公所 / Yonghe District Office; TDX record bus-operator-yonghedistrictoffice-wt2azk.

## What is established

### TDX record identity and route scope

- **Claim.** The committed TDX bus pull identifies bus-operator-yonghedistrictoffice-wt2azk as the Yonghe District Office / 永和區公所 record in the NewTaipei source set, with operator code YongheDistrictOffice, operator number 0506, phone (02)2928-2828 and URL http://www.yonghe.ntpc.gov.tw.
...
- **Original-language sentence.** The repository's TDX operator row contains `id: bus-operator-yonghedistrictoffice-wt2azk`, `names.zh_tw: 永和區公所`, `operatorId: 16240`, `operatorNo: 0506`, `phone: (02)2928-2828`, and `sourceCities: [NewTaipei]`.
...
- **Original-language sentence.** The committed route data contains 5 route objects whose `operatorIds` array includes `bus-operator-yonghedistrictoffice-wt2azk`.
