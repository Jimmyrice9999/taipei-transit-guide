# 平溪區公所 / Pingxi District Office — operator research
...
Researched 22 August 2026. Subject: 平溪區公所 / Pingxi District Office; TDX record bus-operator-pingxidistrictoffice-yh32nd.

## What is established

### TDX record identity and route scope

- **Claim.** The committed TDX bus pull identifies bus-operator-pingxidistrictoffice-yh32nd as the Pingxi District Office / 平溪區公所 record in the NewTaipei source set, with operator code PingxiDistrictOffice, operator number 0505, phone (02)2495-1520 and URL http://www.pingxi.ntpc.gov.tw.
...
- **Original-language sentence.** The repository's TDX operator row contains `id: bus-operator-pingxidistrictoffice-yh32nd`, `names.zh_tw: 平溪區公所`, `operatorId: 16250`, `operatorNo: 0505`, `phone: (02)2495-1520`, and `sourceCities: [NewTaipei]`.
...
- **Original-language sentence.** The committed route data contains 5 route objects whose `operatorIds` array includes `bus-operator-pingxidistrictoffice-yh32nd`.
