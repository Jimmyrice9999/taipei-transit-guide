# 萬里區公所 / Wanli District Office — operator research
...
Researched 22 August 2026. Subject: 萬里區公所 / Wanli District Office; TDX record bus-operator-wanlidistrictoffice-xx3v9f.

## What is established

### TDX record identity and route scope

- **Claim.** The committed TDX bus pull identifies bus-operator-wanlidistrictoffice-xx3v9f as the Wanli District Office / 萬里區公所 record in the NewTaipei source set, with operator code WanliDistrictOffice, operator number 1313, phone (02)2492-2064 and URL http://www.wanli.ntpc.gov.tw.
...
- **Original-language sentence.** The repository's TDX operator row contains `id: bus-operator-wanlidistrictoffice-xx3v9f`, `names.zh_tw: 萬里區公所`, `operatorId: 16252`, `operatorNo: 1313`, `phone: (02)2492-2064`, and `sourceCities: [NewTaipei]`.
...
- **Original-language sentence.** The committed route data contains 7 route objects whose `operatorIds` array includes `bus-operator-wanlidistrictoffice-xx3v9f`.
