...
Researched 22 August 2026. Subject: 烏來區公所 / 烏來區公所; TDX record bus-operator-16479-bepyye.

## What is established

### TDX record identity and route scope

- **Claim.** The committed TDX bus pull identifies bus-operator-16479-bepyye as the 烏來區公所 / 烏來區公所 record in the NewTaipei source set, with operator code TBC, operator number TBC, phone TBC and URL TBC.
...
- **Original-language sentence.** The repository's TDX operator row contains `id: bus-operator-16479-bepyye`, `names.zh_tw: 烏來區公所`, `operatorId: 16479`, `operatorNo: TBC`, `phone: TBC`, and `sourceCities: [NewTaipei]`.
...
- **Original-language sentence.** The committed route data contains 0 route objects whose `operatorIds` array includes `bus-operator-16479-bepyye`.
