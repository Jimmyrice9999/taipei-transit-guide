# 新店區公所 / Xindian District Office — operator research
...
Researched 22 August 2026. Subject: 新店區公所 / Xindian District Office; TDX record bus-operator-xindiandistrictoffice-y70bgf.

## What is established

### TDX record identity and route scope

- **Claim.** The committed TDX bus pull identifies bus-operator-xindiandistrictoffice-y70bgf as the Xindian District Office / 新店區公所 record in the NewTaipei source set, with operator code XindianDistrictOffice, operator number 1311, phone (02)2911-2281 and URL http://www.xindian.ntpc.gov.tw.
...
- **Original-language sentence.** The repository's TDX operator row contains `id: bus-operator-xindiandistrictoffice-y70bgf`, `names.zh_tw: 新店區公所`, `operatorId: 16245`, `operatorNo: 1311`, `phone: (02)2911-2281`, and `sourceCities: [NewTaipei]`.
...
- **Original-language sentence.** The committed route data contains 5 route objects whose `operatorIds` array includes `bus-operator-xindiandistrictoffice-y70bgf`.
