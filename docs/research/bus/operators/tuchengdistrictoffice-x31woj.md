# 土城區公所 / Tucheng District Office — operator research
...
Researched 22 August 2026. Subject: 土城區公所 / Tucheng District Office; TDX record bus-operator-tuchengdistrictoffice-x31woj.

## What is established

### TDX record identity and route scope

- **Claim.** The committed TDX bus pull identifies bus-operator-tuchengdistrictoffice-x31woj as the Tucheng District Office / 土城區公所 record in the NewTaipei source set, with operator code TuchengDistrictOffice, operator number 0306, phone (02)2273-2000 and URL http://www.tucheng.ntpc.gov.tw.
...
- **Original-language sentence.** The repository's TDX operator row contains `id: bus-operator-tuchengdistrictoffice-x31woj`, `names.zh_tw: 土城區公所`, `operatorId: 16241`, `operatorNo: 0306`, `phone: (02)2273-2000`, and `sourceCities: [NewTaipei]`.
...
- **Original-language sentence.** The committed route data contains 0 route objects whose `operatorIds` array includes `bus-operator-tuchengdistrictoffice-x31woj`.
