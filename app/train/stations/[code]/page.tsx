/**
 * /train/stations/[code] — a page per Wenhu station.
 *
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: { canonical: `/train/stations/${station.code.toLowerCase()}/` },
    openGraph: {
      type: 'article',
      title: `${station.code} ${station.name}`,
      description,
      url: `/train/stations/${station.code.toLowerCase()}/`,
    },
    twitter: {
    ...
    <PageShell accent={line}>
      <JsonLd
        data={[
          ...
          breadcrumbSchema([
            ...
            { name: 'Wenhu Line', path: '/train/lines/wenhu-line/' },
            {
              name: `${station.code} ${station.name}`,
              path: `/train/stations/${station.code.toLowerCase()}/`,
            },
          ]),
        ]}
      />

      <Link className="up-link" href="/train/lines/wenhu-line/">
        ‹ Wenhu Line
      </Link>
      ...
      <div className="page-body">
          ...
          <RouteMap
            ...
            stations={stations
              ...
              .map((s, i, all) => ({
                ...
                href: `/train/stations/${s.code.toLowerCase()}/`,
        ...
        <nav className="adjacent wide" aria-label="Adjacent stations">
          {previous ? (
            <Link className="adjacent-link prev" href={`/train/stations/${previous.code.toLowerCase()}/`}>
          ...
          {next ? (
            <Link className="adjacent-link next" href={`/train/stations/${next.code.toLowerCase()}/`}>
